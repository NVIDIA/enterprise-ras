...
# NVUE CLI Configuration for gl-plane1-08
...
nv set interface lo ipv4 address 10.1.1.8/32
...
nv set interface vlan900 ipv4 address 192.168.0.9/20
...
nv set nve vxlan source address 10.1.1.8
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4260395895
nv set router bgp state enabled
nv set router bgp router-id 10.1.1.8
...
nv set system hostname gl-plane1-08
...
#       You are successfully logged in to: gl-plane1-08 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.1.18/32
...
nv set vrf GPU router bgp autonomous-system 4260395895
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.1.8
...
nv set vrf default router bgp autonomous-system 4260395895
...
nv set vrf default router bgp router-id 10.1.1.8
