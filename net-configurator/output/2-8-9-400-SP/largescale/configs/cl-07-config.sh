...
nv set interface bond1s0 evpn multihoming segment local-id 2002
nv set interface bond1s0 description su-02-node-02
nv set interface bond1s1 bond member swp1s1
nv set interface bond1s1 evpn multihoming segment local-id 2003
nv set interface bond1s1 description su-02-node-03
nv set interface bond1s2 bond member swp1s2
nv set interface bond1s2 evpn multihoming segment local-id 4002
nv set interface bond1s2 description su-04-node-02
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 4003
nv set interface bond1s3 description su-04-node-03

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 6002
nv set interface bond2s0 description su-06-node-02
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 6003
nv set interface bond2s1 description su-06-node-03
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 8002
nv set interface bond2s2 description su-08-node-02
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 8003
nv set interface bond2s3 description su-08-node-03

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 10002
nv set interface bond3s0 description su-10-node-02
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 10003
nv set interface bond3s1 description su-10-node-03
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 12002
nv set interface bond3s2 description su-12-node-02
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 12003
nv set interface bond3s3 description su-12-node-03

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 14002
nv set interface bond4s0 description su-14-node-02
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 14003
nv set interface bond4s1 description su-14-node-03
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 16002
nv set interface bond4s2 description su-16-node-02
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 16003
nv set interface bond4s3 description su-16-node-03

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 18002
nv set interface bond5s0 description su-18-node-02
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 18003
nv set interface bond5s1 description su-18-node-03
nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 20002
nv set interface bond5s2 description su-20-node-02
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 20003
nv set interface bond5s3 description su-20-node-03

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 22002
nv set interface bond6s0 description su-22-node-02
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 22003
nv set interface bond6s1 description su-22-node-03
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 24002
nv set interface bond6s2 description su-24-node-02
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 24003
nv set interface bond6s3 description su-24-node-03

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 26002
nv set interface bond7s0 description su-26-node-02
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 26003
nv set interface bond7s1 description su-26-node-03
nv set interface bond7s2 bond member swp7s2
nv set interface bond7s2 evpn multihoming segment local-id 28002
nv set interface bond7s2 description su-28-node-02
nv set interface bond7s3 bond member swp7s3
nv set interface bond7s3 evpn multihoming segment local-id 28003
nv set interface bond7s3 description su-28-node-03

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 30002
nv set interface bond8s0 description su-30-node-02
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 30003
nv set interface bond8s1 description su-30-node-03
nv set interface bond8s2 bond member swp8s2
nv set interface bond8s2 evpn multihoming segment local-id 32002
nv set interface bond8s2 description su-32-node-02
nv set interface bond8s3 bond member swp8s3
nv set interface bond8s3 evpn multihoming segment local-id 32003
nv set interface bond8s3 description su-32-node-03
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.17/32
...
nv set interface vlan500 ipv4 address 172.16.180.8/24
...
nv set nve vxlan source address 172.16.176.17

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4260395195
nv set router bgp router-id 172.16.176.17
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.176.11/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.9/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.9/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.7/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.7/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.7/32 max-prefix-len 32
...
nv set vrf EXIT loopback ip address 172.16.176.11/32
...
nv set vrf EXIT router bgp autonomous-system 4260395195
...
nv set vrf INBAND loopback ip address 172.16.176.9/32
...
nv set vrf INBAND router bgp autonomous-system 4260395195
...
nv set vrf INBAND router bgp router-id 172.16.176.9

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.176.7/32
...
nv set vrf OOB router bgp autonomous-system 4260395195
nv set vrf OOB router bgp state enabled

nv set vrf OOB router bgp router-id 172.16.176.7
...
nv set vrf STORAGE router bgp autonomous-system 4260395195
nv set vrf STORAGE router bgp state enabled

nv set vrf STORAGE router bgp route-export
nv set vrf STORAGE router bgp router-id 172.16.176.17
...
#       You are successfully logged in to: cl-07 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
