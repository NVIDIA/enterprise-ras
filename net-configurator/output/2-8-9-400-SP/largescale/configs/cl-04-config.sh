...
nv set interface swp57s0,swp57s1,swp57s2,swp57s3 link speed 100G
...
nv set interface bond2s0 evpn multihoming segment local-id 3002
nv set interface bond2s0 description su-03-node-02
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 4002
nv set interface bond2s1 description su-04-node-02

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 5002
nv set interface bond3s0 description su-05-node-02
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 6002
nv set interface bond3s1 description su-06-node-02

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 7002
nv set interface bond4s0 description su-07-node-02
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 8002
nv set interface bond4s1 description su-08-node-02

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 9002
nv set interface bond5s0 description su-09-node-02
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 10002
nv set interface bond5s1 description su-10-node-02

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 11002
nv set interface bond6s0 description su-11-node-02
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 12002
nv set interface bond6s1 description su-12-node-02

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 13002
nv set interface bond7s0 description su-13-node-02
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 14002
nv set interface bond7s1 description su-14-node-02

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 15002
nv set interface bond8s0 description su-15-node-02
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 16002
nv set interface bond8s1 description su-16-node-02

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 17002
nv set interface bond9s0 description su-17-node-02
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 18002
nv set interface bond9s1 description su-18-node-02

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 19002
nv set interface bond10s0 description su-19-node-02
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 20002
nv set interface bond10s1 description su-20-node-02

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 21002
nv set interface bond11s0 description su-21-node-02
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 22002
nv set interface bond11s1 description su-22-node-02

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 23002
nv set interface bond12s0 description su-23-node-02
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 24002
nv set interface bond12s1 description su-24-node-02

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 25002
nv set interface bond13s0 description su-25-node-02
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 26002
nv set interface bond13s1 description su-26-node-02

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 27002
nv set interface bond14s0 description su-27-node-02
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 28002
nv set interface bond14s1 description su-28-node-02

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 29002
nv set interface bond15s0 description su-29-node-02
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 30002
nv set interface bond15s1 description su-30-node-02

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 31002
nv set interface bond16s0 description su-31-node-02
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 32002
nv set interface bond16s1 description su-32-node-02
...
nv set interface bond17s0 evpn multihoming segment local-id 800002
nv set interface bond17s0 description support-02
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 800006
nv set interface bond17s1 description support-06
...
nv set interface swp57s0,swp57s1,swp57s2,swp57s3 description oob_uplink
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.176.186/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.170/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.170/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.154/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.154/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.154/32 max-prefix-len 32
...
nv set vrf EXIT loopback ip address 172.16.176.186/32
...
nv set vrf EXIT router bgp router-id 172.16.176.186

nv set vrf INBAND evpn state enabled
nv set vrf INBAND evpn vlan 3002
nv set vrf INBAND evpn vni 5002

nv set vrf INBAND loopback ip address 172.16.176.170/32
...
nv set vrf INBAND router bgp router-id 172.16.176.170

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.176.154/32
...
nv set vrf OOB router bgp router-id 172.16.176.154

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.176.202/32
...
nv set vrf STORAGE router bgp router-id 172.16.176.202
