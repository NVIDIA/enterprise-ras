...
nv set interface bond2s0 evpn multihoming segment local-id 3004
nv set interface bond2s0 description su-03-node-04
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 4004
nv set interface bond2s1 description su-04-node-04

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 5004
nv set interface bond3s0 description su-05-node-04
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 6004
nv set interface bond3s1 description su-06-node-04

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 7004
nv set interface bond4s0 description su-07-node-04
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 8004
nv set interface bond4s1 description su-08-node-04

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 9004
nv set interface bond5s0 description su-09-node-04
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 10004
nv set interface bond5s1 description su-10-node-04

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 11004
nv set interface bond6s0 description su-11-node-04
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 12004
nv set interface bond6s1 description su-12-node-04

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 13004
nv set interface bond7s0 description su-13-node-04
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 14004
nv set interface bond7s1 description su-14-node-04

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 15004
nv set interface bond8s0 description su-15-node-04
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 16004
nv set interface bond8s1 description su-16-node-04

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 17004
nv set interface bond9s0 description su-17-node-04
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 18004
nv set interface bond9s1 description su-18-node-04

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 19004
nv set interface bond10s0 description su-19-node-04
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 20004
nv set interface bond10s1 description su-20-node-04

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 21004
nv set interface bond11s0 description su-21-node-04
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 22004
nv set interface bond11s1 description su-22-node-04

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 23004
nv set interface bond12s0 description su-23-node-04
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 24004
nv set interface bond12s1 description su-24-node-04

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 25004
nv set interface bond13s0 description su-25-node-04
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 26004
nv set interface bond13s1 description su-26-node-04

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 27004
nv set interface bond14s0 description su-27-node-04
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 28004
nv set interface bond14s1 description su-28-node-04

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 29004
nv set interface bond15s0 description su-29-node-04
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 30004
nv set interface bond15s1 description su-30-node-04

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 31004
nv set interface bond16s0 description su-31-node-04
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 32004
nv set interface bond16s1 description su-32-node-04
...
nv set interface bond17s0 evpn multihoming segment local-id 800004
nv set interface bond17s0 description support-04
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 800008
nv set interface bond17s1 description support-08
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.176.190/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.174/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.174/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.158/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.158/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.158/32 max-prefix-len 32
...
nv set vrf EXIT loopback ip address 172.16.176.190/32
...
nv set vrf EXIT router bgp router-id 172.16.176.190

nv set vrf INBAND evpn state enabled
nv set vrf INBAND evpn vlan 3002
nv set vrf INBAND evpn vni 5002

nv set vrf INBAND loopback ip address 172.16.176.174/32
...
nv set vrf INBAND router bgp router-id 172.16.176.174

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.176.158/32
...
nv set vrf OOB router bgp router-id 172.16.176.158

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.176.206/32
...
nv set vrf STORAGE router bgp router-id 172.16.176.206
