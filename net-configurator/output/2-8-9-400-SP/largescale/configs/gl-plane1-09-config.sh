...
# NVUE CLI Configuration for gl-plane1-09
...
nv set interface lo ipv4 address 10.1.1.9/32
...
nv set interface vlan900 ipv4 address 192.168.0.10/20
...
nv set nve vxlan source address 10.1.1.9
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4260395896
nv set router bgp state enabled
nv set router bgp router-id 10.1.1.9
...
nv set system hostname gl-plane1-09
...
#       You are successfully logged in to: gl-plane1-09 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.1.19/32
...
nv set vrf GPU router bgp autonomous-system 4260395896
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.1.9
...
nv set vrf default router bgp autonomous-system 4260395896
...
nv set vrf default router bgp router-id 10.1.1.9
