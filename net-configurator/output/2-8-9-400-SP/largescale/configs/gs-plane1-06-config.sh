...
# NVUE CLI Configuration for gs-plane1-06
...
nv set interface lo ipv4 address 10.1.1.46/32
...
nv set router bgp router-id 10.1.1.46
...
nv set system hostname gs-plane1-06
...
#       You are successfully logged in to: gs-plane1-06 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp router-id 10.1.1.46
