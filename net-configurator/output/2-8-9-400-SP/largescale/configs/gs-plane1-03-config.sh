...
# NVUE CLI Configuration for gs-plane1-03
...
nv set interface lo ipv4 address 10.1.1.43/32
...
nv set router bgp router-id 10.1.1.43
...
nv set system hostname gs-plane1-03
...
#       You are successfully logged in to: gs-plane1-03 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp router-id 10.1.1.43
