...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.3/32 max-prefix-len 32
...
nv set vrf INBAND router bgp router-id 172.16.176.3
...
nv set vrf OOB router bgp router-id 172.16.176.1
...
nv set vrf STORAGE router bgp router-id 172.16.176.11
...
#       You are successfully logged in to: cl-01 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
