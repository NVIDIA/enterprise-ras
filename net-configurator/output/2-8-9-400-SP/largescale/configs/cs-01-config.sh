...
nv set interface lo ipv4 address 172.16.176.61/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4260395289
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.61
...
#       You are successfully logged in to: cs-01 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp router-id 172.16.176.61
