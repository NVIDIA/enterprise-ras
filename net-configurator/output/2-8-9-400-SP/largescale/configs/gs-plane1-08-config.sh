...
# NVUE CLI Configuration for gs-plane1-08
...
nv set interface lo ipv4 address 10.1.1.48/32
...
nv set router bgp router-id 10.1.1.48
...
nv set system hostname gs-plane1-08
...
#       You are successfully logged in to: gs-plane1-08 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp router-id 10.1.1.48
