...
# NVUE CLI Configuration for gs-plane1-04
# Generated: 2026-07-03T00:13:17Z
...
nv set interface lo ipv4 address 10.1.1.44/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4260395887
nv set router bgp state enabled
nv set router bgp router-id 10.1.1.44
...
nv set system hostname gs-plane1-04
...
#       You are successfully logged in to: gs-plane1-04 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp neighbor 10.1.1.3 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.3 type numbered
nv set vrf default router bgp neighbor 10.1.1.4 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.4 type numbered
nv set vrf default router bgp neighbor 10.1.1.5 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.5 type numbered
nv set vrf default router bgp neighbor 10.1.1.6 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.6 type numbered
nv set vrf default router bgp neighbor 10.1.1.7 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.7 type numbered
nv set vrf default router bgp neighbor 10.1.1.8 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.8 type numbered
nv set vrf default router bgp neighbor 10.1.1.9 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.9 type numbered
nv set vrf default router bgp neighbor 10.1.1.10 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.10 type numbered
nv set vrf default router bgp neighbor 10.1.1.11 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.11 type numbered
nv set vrf default router bgp neighbor 10.1.1.12 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.12 type numbered
nv set vrf default router bgp neighbor 10.1.1.13 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.13 type numbered
nv set vrf default router bgp neighbor 10.1.1.14 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.14 type numbered
nv set vrf default router bgp neighbor 10.1.1.15 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.15 type numbered
nv set vrf default router bgp neighbor 10.1.1.16 peer-group overlay
nv set vrf default router bgp neighbor 10.1.1.16 type numbered
...
nv set vrf default router bgp neighbor swp58s0 peer-group underlay
nv set vrf default router bgp neighbor swp58s0 type unnumbered
nv set vrf default router bgp neighbor swp58s1 peer-group underlay
...
nv set vrf default router bgp neighbor swp60s0 peer-group underlay
nv set vrf default router bgp neighbor swp60s0 type unnumbered
nv set vrf default router bgp neighbor swp60s1 peer-group underlay
nv set vrf default router bgp neighbor swp60s1 type unnumbered
nv set vrf default router bgp neighbor swp61s0 peer-group underlay
nv set vrf default router bgp neighbor swp61s0 type unnumbered
nv set vrf default router bgp neighbor swp61s1 peer-group underlay
nv set vrf default router bgp neighbor swp61s1 type unnumbered
nv set vrf default router bgp neighbor swp62s0 peer-group underlay
nv set vrf default router bgp neighbor swp62s0 type unnumbered
nv set vrf default router bgp neighbor swp62s1 peer-group underlay
...
nv set vrf default router bgp neighbor swp64s0 peer-group underlay
nv set vrf default router bgp neighbor swp64s0 type unnumbered
nv set vrf default router bgp neighbor swp64s1 peer-group underlay
...
nv set vrf default router bgp router-id 10.1.1.44
