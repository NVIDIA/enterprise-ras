...
nv set interface lo ipv4 address 172.16.176.64/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4260395292
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.64
...
#       You are successfully logged in to: cs-04 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp router-id 172.16.176.64
