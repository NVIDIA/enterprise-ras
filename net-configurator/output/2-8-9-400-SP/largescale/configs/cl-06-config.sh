...
nv set interface bond2s0 evpn multihoming segment local-id 3003
nv set interface bond2s0 description su-03-node-03
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 4003
nv set interface bond2s1 description su-04-node-03

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 5003
nv set interface bond3s0 description su-05-node-03
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 6003
nv set interface bond3s1 description su-06-node-03

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 7003
nv set interface bond4s0 description su-07-node-03
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 8003
nv set interface bond4s1 description su-08-node-03

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 9003
nv set interface bond5s0 description su-09-node-03
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 10003
nv set interface bond5s1 description su-10-node-03

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 11003
nv set interface bond6s0 description su-11-node-03
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 12003
nv set interface bond6s1 description su-12-node-03

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 13003
nv set interface bond7s0 description su-13-node-03
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 14003
nv set interface bond7s1 description su-14-node-03

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 15003
nv set interface bond8s0 description su-15-node-03
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 16003
nv set interface bond8s1 description su-16-node-03

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 17003
nv set interface bond9s0 description su-17-node-03
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 18003
nv set interface bond9s1 description su-18-node-03

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 19003
nv set interface bond10s0 description su-19-node-03
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 20003
nv set interface bond10s1 description su-20-node-03

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 21003
nv set interface bond11s0 description su-21-node-03
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 22003
nv set interface bond11s1 description su-22-node-03

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 23003
nv set interface bond12s0 description su-23-node-03
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 24003
nv set interface bond12s1 description su-24-node-03

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 25003
nv set interface bond13s0 description su-25-node-03
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 26003
nv set interface bond13s1 description su-26-node-03

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 27003
nv set interface bond14s0 description su-27-node-03
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 28003
nv set interface bond14s1 description su-28-node-03

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 29003
nv set interface bond15s0 description su-29-node-03
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 30003
nv set interface bond15s1 description su-30-node-03

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 31003
nv set interface bond16s0 description su-31-node-03
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 32003
nv set interface bond16s1 description su-32-node-03
...
nv set interface bond17s0 evpn multihoming segment local-id 800003
nv set interface bond17s0 description support-03
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 800007
nv set interface bond17s1 description support-07
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.176.188/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.172/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.172/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.156/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.156/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.156/32 max-prefix-len 32
...
nv set vrf EXIT loopback ip address 172.16.176.188/32
...
nv set vrf EXIT router bgp router-id 172.16.176.188

nv set vrf INBAND evpn state enabled
nv set vrf INBAND evpn vlan 3002
nv set vrf INBAND evpn vni 5002

nv set vrf INBAND loopback ip address 172.16.176.172/32
...
nv set vrf INBAND router bgp router-id 172.16.176.172

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.176.156/32
...
nv set vrf OOB router bgp router-id 172.16.176.156

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.176.204/32
...
nv set vrf STORAGE router bgp router-id 172.16.176.204
