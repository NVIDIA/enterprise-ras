...
nv set interface bond1s2 evpn multihoming segment local-id 3001
nv set interface bond1s2 description su-03-node-01
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 3002
nv set interface bond1s3 description su-03-node-02

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 5001
nv set interface bond2s0 description su-05-node-01
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 5002
nv set interface bond2s1 description su-05-node-02
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 7001
nv set interface bond2s2 description su-07-node-01
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 7002
nv set interface bond2s3 description su-07-node-02

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 9001
nv set interface bond3s0 description su-09-node-01
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 9002
nv set interface bond3s1 description su-09-node-02
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 11001
nv set interface bond3s2 description su-11-node-01
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 11002
nv set interface bond3s3 description su-11-node-02

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 13001
nv set interface bond4s0 description su-13-node-01
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 13002
nv set interface bond4s1 description su-13-node-02
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 15001
nv set interface bond4s2 description su-15-node-01
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 15002
nv set interface bond4s3 description su-15-node-02

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 17001
nv set interface bond5s0 description su-17-node-01
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 17002
nv set interface bond5s1 description su-17-node-02
nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 19001
nv set interface bond5s2 description su-19-node-01
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 19002
nv set interface bond5s3 description su-19-node-02

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 21001
nv set interface bond6s0 description su-21-node-01
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 21002
nv set interface bond6s1 description su-21-node-02
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 23001
nv set interface bond6s2 description su-23-node-01
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 23002
nv set interface bond6s3 description su-23-node-02

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 25001
nv set interface bond7s0 description su-25-node-01
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 25002
nv set interface bond7s1 description su-25-node-02
nv set interface bond7s2 bond member swp7s2
nv set interface bond7s2 evpn multihoming segment local-id 27001
nv set interface bond7s2 description su-27-node-01
nv set interface bond7s3 bond member swp7s3
nv set interface bond7s3 evpn multihoming segment local-id 27002
nv set interface bond7s3 description su-27-node-02

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 29001
nv set interface bond8s0 description su-29-node-01
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 29002
nv set interface bond8s1 description su-29-node-02
nv set interface bond8s2 bond member swp8s2
nv set interface bond8s2 evpn multihoming segment local-id 31001
nv set interface bond8s2 description su-31-node-01
nv set interface bond8s3 bond member swp8s3
nv set interface bond8s3 evpn multihoming segment local-id 31002
nv set interface bond8s3 description su-31-node-02

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 800001
nv set interface bond10s0 description support-01
...
nv set router bgp autonomous-system 4260395190
...
nv set vrf EXIT router bgp autonomous-system 4260395190
...
nv set vrf INBAND router bgp autonomous-system 4260395190
...
nv set vrf OOB router bgp autonomous-system 4260395190
...
nv set vrf STORAGE router bgp autonomous-system 4260395190
nv set vrf STORAGE router bgp state enabled

nv set vrf STORAGE router bgp route-export
nv set vrf STORAGE router bgp router-id 172.16.176.12
...
#       You are successfully logged in to: cl-02 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
