...
nv set interface bond1s2 evpn multihoming segment local-id 3004
nv set interface bond1s2 description su-03-node-04
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 4001
nv set interface bond1s3 description su-04-node-01

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 5004
nv set interface bond2s0 description su-05-node-04
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 6001
nv set interface bond2s1 description su-06-node-01
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 7004
nv set interface bond2s2 description su-07-node-04
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 8001
nv set interface bond2s3 description su-08-node-01

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 9004
nv set interface bond3s0 description su-09-node-04
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 10001
nv set interface bond3s1 description su-10-node-01
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 11004
nv set interface bond3s2 description su-11-node-04
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 12001
nv set interface bond3s3 description su-12-node-01

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 13004
nv set interface bond4s0 description su-13-node-04
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 14001
nv set interface bond4s1 description su-14-node-01
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 15004
nv set interface bond4s2 description su-15-node-04
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 16001
nv set interface bond4s3 description su-16-node-01

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 17004
nv set interface bond5s0 description su-17-node-04
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 18001
nv set interface bond5s1 description su-18-node-01
nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 19004
nv set interface bond5s2 description su-19-node-04
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 20001
nv set interface bond5s3 description su-20-node-01

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 21004
nv set interface bond6s0 description su-21-node-04
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 22001
nv set interface bond6s1 description su-22-node-01
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 23004
nv set interface bond6s2 description su-23-node-04
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 24001
nv set interface bond6s3 description su-24-node-01

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 25004
nv set interface bond7s0 description su-25-node-04
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 26001
nv set interface bond7s1 description su-26-node-01
nv set interface bond7s2 bond member swp7s2
nv set interface bond7s2 evpn multihoming segment local-id 27004
nv set interface bond7s2 description su-27-node-04
nv set interface bond7s3 bond member swp7s3
nv set interface bond7s3 evpn multihoming segment local-id 28001
nv set interface bond7s3 description su-28-node-01

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 29004
nv set interface bond8s0 description su-29-node-04
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 30001
nv set interface bond8s1 description su-30-node-01
nv set interface bond8s2 bond member swp8s2
nv set interface bond8s2 evpn multihoming segment local-id 31004
nv set interface bond8s2 description su-31-node-04
nv set interface bond8s3 bond member swp8s3
nv set interface bond8s3 evpn multihoming segment local-id 32001
nv set interface bond8s3 description su-32-node-01
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.15/32
...
nv set interface vlan500 ipv4 address 172.16.180.6/24
...
nv set nve vxlan source address 172.16.176.15

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4260395193
nv set router bgp router-id 172.16.176.15
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.176.9/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.7/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.176.7/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.5/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.5/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.5/32 max-prefix-len 32
...
nv set vrf EXIT loopback ip address 172.16.176.9/32
...
nv set vrf EXIT router bgp autonomous-system 4260395193
...
nv set vrf EXIT router bgp router-id 172.16.176.9

nv set vrf INBAND evpn state enabled
nv set vrf INBAND evpn vlan 3002
nv set vrf INBAND evpn vni 5002

nv set vrf INBAND loopback ip address 172.16.176.7/32
...
nv set vrf INBAND router bgp autonomous-system 4260395193
...
nv set vrf INBAND router bgp router-id 172.16.176.7

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.176.5/32
...
nv set vrf OOB router bgp autonomous-system 4260395193
nv set vrf OOB router bgp state enabled

nv set vrf OOB router bgp router-id 172.16.176.5
...
nv set vrf STORAGE router bgp autonomous-system 4260395193
nv set vrf STORAGE router bgp state enabled

nv set vrf STORAGE router bgp route-export
nv set vrf STORAGE router bgp router-id 172.16.176.15
...
#       You are successfully logged in to: cl-05 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
