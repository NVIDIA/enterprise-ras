...
# NVUE CLI Configuration for oob-switch-04
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.104/32
...
nv set nve vxlan source address 172.16.176.104
...
nv set router bgp autonomous-system 4260394792
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.104
...
nv set system hostname oob-switch-04
...
#       You are successfully logged in to: oob-switch-04 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.176.124/32
...
nv set vrf OOB router bgp autonomous-system 4260394792
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.176.124
