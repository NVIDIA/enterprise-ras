...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.102/32
...
nv set nve vxlan source address 172.16.176.102
...
nv set router bgp router-id 172.16.176.102
...
#       You are successfully logged in to: oob-switch-02 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.176.122/32
...
nv set vrf OOB router bgp router-id 172.16.176.122
