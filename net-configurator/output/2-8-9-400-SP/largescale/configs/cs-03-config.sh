...
nv set interface lo ipv4 address 172.16.176.63/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4260395291
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.63
...
#       You are successfully logged in to: cs-03 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf default router bgp neighbor 172.16.176.13 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.13 type numbered
nv set vrf default router bgp neighbor 172.16.176.14 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.14 type numbered
nv set vrf default router bgp neighbor 172.16.176.15 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.15 type numbered
nv set vrf default router bgp neighbor 172.16.176.16 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.16 type numbered
nv set vrf default router bgp neighbor 172.16.176.17 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.17 type numbered
nv set vrf default router bgp neighbor 172.16.176.18 peer-group overlay
nv set vrf default router bgp neighbor 172.16.176.18 type numbered
...
nv set vrf default router bgp router-id 172.16.176.63
