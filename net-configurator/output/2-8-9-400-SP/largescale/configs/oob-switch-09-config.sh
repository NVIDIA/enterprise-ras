...
# NVUE CLI Configuration for oob-switch-09
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.109/32
...
# VLAN SVI
#============================================================================
nv set interface vlan200 ipv4 address 192.168.200.10/24
...
nv set nve vxlan source address 172.16.176.109
...
nv set router bgp autonomous-system 4260394797
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.109
...
nv set system hostname oob-switch-09
...
#       You are successfully logged in to: oob-switch-09 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.176.129/32
...
nv set vrf OOB router bgp autonomous-system 4260394797
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.176.129
