...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.103/32
...
nv set nve vxlan source address 172.16.176.103
...
nv set router bgp autonomous-system 4260394791
nv set router bgp state enabled
nv set router bgp router-id 172.16.176.103
...
#       You are successfully logged in to: oob-switch-03 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.176.123/32
...
nv set vrf OOB router bgp autonomous-system 4260394791
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.176.123
