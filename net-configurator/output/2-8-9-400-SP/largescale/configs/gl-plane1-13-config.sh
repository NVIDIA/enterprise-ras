...
nv set interface lo ipv4 address 10.1.1.13/32
...
nv set interface vlan900 ipv4 address 192.168.0.14/20
...
nv set nve vxlan source address 10.1.1.13
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4260395900
...
nv set system hostname gl-plane1-13
...
#       You are successfully logged in to: gl-plane1-13 - site: largescale / arch: 2-8-9-400-SP
####################################################################'
...
nv set vrf GPU router bgp autonomous-system 4260395900
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.1.13
...
nv set vrf default router bgp autonomous-system 4260395900
...
nv set vrf default router bgp router-id 10.1.1.13
