...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4260396898
...
nv set system hostname gl-plane2-11
...
#       You are successfully logged in to: gl-plane2-11 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf GPU router bgp autonomous-system 4260396898
...
nv set vrf default router bgp autonomous-system 4260396898
