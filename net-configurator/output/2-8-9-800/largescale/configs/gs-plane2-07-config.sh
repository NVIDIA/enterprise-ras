...
# NVUE CLI Configuration for gs-plane2-07
...
nv set interface lo ipv4 address 10.1.2.47/32
...
nv set router bgp router-id 10.1.2.47
...
nv set system hostname gs-plane2-07
...
#       You are successfully logged in to: gs-plane2-07 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf default router bgp router-id 10.1.2.47
