...
# NVUE CLI Configuration for gs-plane2-04
...
nv set interface lo ipv4 address 10.1.2.44/32
...
nv set router bgp router-id 10.1.2.44
...
nv set system hostname gs-plane2-04
...
#       You are successfully logged in to: gs-plane2-04 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf default router bgp router-id 10.1.2.44
