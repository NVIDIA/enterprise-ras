...
# NVUE CLI Configuration for gl-plane2-08
...
nv set interface lo ipv4 address 10.1.2.8/32
...
nv set interface vlan900 ipv4 address 192.168.16.9/20
...
nv set nve vxlan source address 10.1.2.8
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4260396895
nv set router bgp state enabled
nv set router bgp router-id 10.1.2.8
...
nv set system hostname gl-plane2-08
...
#       You are successfully logged in to: gl-plane2-08 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.2.18/32
...
nv set vrf GPU router bgp autonomous-system 4260396895
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.2.8
...
nv set vrf default router bgp autonomous-system 4260396895
...
nv set vrf default router bgp router-id 10.1.2.8
