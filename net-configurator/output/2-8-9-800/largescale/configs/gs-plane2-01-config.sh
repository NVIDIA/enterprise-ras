...
# NVUE CLI Configuration for gs-plane2-01
...
nv set interface lo ipv4 address 10.1.2.41/32
...
nv set router bgp router-id 10.1.2.41
...
nv set system hostname gs-plane2-01
...
#       You are successfully logged in to: gs-plane2-01 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf default router bgp router-id 10.1.2.41
