...
nv set interface lo ipv4 address 10.1.2.45/32
...
nv set router bgp router-id 10.1.2.45
...
#       You are successfully logged in to: gs-plane2-05 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf default router bgp router-id 10.1.2.45
