...
# NVUE CLI Configuration for gs-plane2-02
...
nv set interface lo ipv4 address 10.2.1.42/32
...
nv set router bgp router-id 10.2.1.42
...
nv set system hostname gs-plane2-02
...
#       You are successfully logged in to: gs-plane2-02 - site: largescale / arch: 2-8-9-800
####################################################################'
...
nv set vrf default router bgp router-id 10.2.1.42
