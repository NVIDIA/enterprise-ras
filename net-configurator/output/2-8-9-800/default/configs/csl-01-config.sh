...
nv set vrf STORAGE loopback ip address 172.16.176.7/32
...
nv set vrf STORAGE router bgp router-id 172.16.176.7
...
#       You are successfully logged in to: csl-01 - site: default / arch: 2-8-9-800
####################################################################'
