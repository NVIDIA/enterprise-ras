...
# Generated: 2026-09-02T02:43:44Z
...
#============================================================================
nv set interface swp1,swp2,swp3,swp4,swp5,swp6,swp7,swp8,swp9,swp10,swp62,swp63,swp64 link breakout 4x lanes-per-port 2
nv set interface swp11,swp12,swp13,swp14,swp15,swp16,swp17,swp18,swp19 link breakout 2x lanes-per-port 4
nv set interface swp59 link breakout 8x lanes-per-port 1
nv set interface swp59s0,swp59s1,swp59s2,swp59s3 link speed 100G
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3,swp62s0,swp62s1,swp62s2,swp62s3 link speed 200G
nv set interface swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1 link speed 400G
...
nv set interface bond9s0 description support-01
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 91
nv set interface bond9s1 description support-02
nv set interface bond9s2 bond member swp9s2
nv set interface bond9s2 evpn multihoming segment local-id 92
nv set interface bond9s2 description support-03
nv set interface bond9s3 bond member swp9s3
nv set interface bond9s3 evpn multihoming segment local-id 93
nv set interface bond9s3 description support-04

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 100
nv set interface bond10s0 description support-05
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 101
nv set interface bond10s1 description support-06
nv set interface bond10s2 bond member swp10s2
nv set interface bond10s2 evpn multihoming segment local-id 102
nv set interface bond10s2 description support-07
nv set interface bond10s3 bond member swp10s3
nv set interface bond10s3 evpn multihoming segment local-id 103
nv set interface bond10s3 description support-08

# SUPPORT role - 2 ports, 8 bonds
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 evpn multihoming segment state enabled
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 evpn multihoming segment mac-address 44:38:39:FF:00:AA
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 type bond
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 bridge domain br_default vlan 200,300,400
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 bridge domain br_default untagged 300
nv set interface bond9s0,bond9s1,bond9s2,bond9s3,bond10s0,bond10s1,bond10s2,bond10s3 bond lacp-bypass enabled
...
nv set interface swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1 description isl_to_peer_core_switch
nv set interface swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1 evpn multihoming uplink enabled

# EDGE role - direct interfaces
nv set interface swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 description edge_uplink
nv set interface swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 vrf EXIT

# OOB role - direct L3 uplinks
nv set interface swp59s0,swp59s1,swp59s2,swp59s3 description oob_uplink

# STORAGE role - L3 external uplinks
nv set interface swp62s0,swp62s1,swp62s2,swp62s3 description external_uplink_storage_vrf
nv set interface swp62s0,swp62s1,swp62s2,swp62s3 vrf STORAGE
...
nv set interface swp20,swp21,swp22,swp23,swp24,swp25,swp26,swp27,swp28,swp29,swp30,swp31,swp32,swp33,swp34,swp35,swp36,swp37,swp38,swp39,swp40,swp41,swp42,swp43,swp44,swp45,swp46,swp47,swp48,swp49,swp50,swp51,swp52,swp53,swp54,swp55,swp56,swp57,swp58,swp61,swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 type swp

nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 telemetry histogram counter counter-type rx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 telemetry histogram counter counter-type tx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 telemetry histogram egress-buffer traffic-class 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 telemetry histogram ingress-buffer priority-group 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp59s0,swp59s1,swp59s2,swp59s3,swp63s0,swp63s1,swp63s2,swp63s3,swp64s0,swp64s1,swp64s2,swp64s3 telemetry histogram ingress-buffer priority-group 1
...
nv set vrf STORAGE router bgp neighbor swp62s3 peer-group storage
nv set vrf STORAGE router bgp neighbor swp62s3 type unnumbered
...
nv set vrf default router bgp neighbor swp11s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp11s0 type unnumbered
nv set vrf default router bgp neighbor swp11s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp11s1 type unnumbered
nv set vrf default router bgp neighbor swp12s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp12s0 type unnumbered
nv set vrf default router bgp neighbor swp12s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp12s1 type unnumbered
nv set vrf default router bgp neighbor swp13s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp13s0 type unnumbered
nv set vrf default router bgp neighbor swp13s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp13s1 type unnumbered
nv set vrf default router bgp neighbor swp14s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp14s0 type unnumbered
nv set vrf default router bgp neighbor swp14s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp14s1 type unnumbered
nv set vrf default router bgp neighbor swp15s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp15s0 type unnumbered
nv set vrf default router bgp neighbor swp15s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp15s1 type unnumbered
nv set vrf default router bgp neighbor swp16s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp16s0 type unnumbered
nv set vrf default router bgp neighbor swp16s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp16s1 type unnumbered
nv set vrf default router bgp neighbor swp17s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp17s0 type unnumbered
nv set vrf default router bgp neighbor swp17s1 peer-group internal_isl
nv set vrf default router bgp neighbor swp17s1 type unnumbered
nv set vrf default router bgp neighbor swp18s0 peer-group internal_isl
nv set vrf default router bgp neighbor swp18s0 type unnumbered
nv set vrf default router bgp neighbor swp18s1 peer-group internal_isl
...
nv set vrf default router bgp neighbor swp59s3 peer-group underlay
nv set vrf default router bgp neighbor swp59s3 type unnumbered
...
#       You are successfully logged in to: csl-02 - site: largescale / arch: 2-4-5-400
####################################################################'
