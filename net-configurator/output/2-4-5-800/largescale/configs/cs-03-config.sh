...
# NVUE CLI Configuration for cs-03
...
nv set interface lo ipv4 address 172.16.1.63/32
nv set interface lo type loopback

# Breakout 2x on ISL ports (leaves)
nv set interface swp1,swp2,swp3,swp4,swp5,swp6,swp7,swp8,swp9,swp10,swp11,swp12,swp13,swp14,swp15,swp16,swp17,swp18,swp19,swp20,swp21,swp22,swp23,swp24,swp25,swp26,swp27,swp28,swp29,swp30,swp31,swp32,swp33,swp34,swp35,swp36,swp37,swp38,swp39,swp40,swp41,swp42,swp43,swp44,swp45,swp46,swp47,swp48,swp49,swp50,swp51,swp52,swp53,swp54,swp55,swp56 link breakout 2x
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4200100504
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.63
...
#       You are successfully logged in to: cs-03 - site: largescale / arch: 2-4-5-800
####################################################################'
...
#============================================================================
nv set vrf default router bgp neighbor 172.16.1.11 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.11 type numbered
nv set vrf default router bgp neighbor 172.16.1.12 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.12 type numbered
nv set vrf default router bgp neighbor 172.16.1.13 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.13 type numbered
nv set vrf default router bgp neighbor 172.16.1.14 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.14 type numbered
nv set vrf default router bgp neighbor 172.16.1.15 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.15 type numbered
nv set vrf default router bgp neighbor 172.16.1.16 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.16 type numbered
nv set vrf default router bgp neighbor 172.16.1.17 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.17 type numbered
...
nv set vrf default router bgp neighbor 172.16.1.105 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.105 type numbered
nv set vrf default router bgp neighbor 172.16.1.106 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.106 type numbered
nv set vrf default router bgp neighbor 172.16.1.107 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.107 type numbered
nv set vrf default router bgp neighbor 172.16.1.108 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.108 type numbered
nv set vrf default router bgp neighbor 172.16.1.109 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.109 type numbered
nv set vrf default router bgp neighbor 172.16.1.110 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.110 type numbered
nv set vrf default router bgp neighbor 172.16.1.111 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.111 type numbered
nv set vrf default router bgp neighbor 172.16.1.112 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.112 type numbered
nv set vrf default router bgp neighbor 172.16.1.113 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.113 type numbered
nv set vrf default router bgp neighbor 172.16.1.114 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.114 type numbered
nv set vrf default router bgp neighbor 172.16.1.115 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.115 type numbered
nv set vrf default router bgp neighbor 172.16.1.116 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.116 type numbered
nv set vrf default router bgp neighbor 172.16.1.117 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.117 type numbered
nv set vrf default router bgp neighbor 172.16.1.118 peer-group overlay
nv set vrf default router bgp neighbor 172.16.1.118 type numbered
...
nv set vrf default router bgp neighbor swp50s0 peer-group underlay
nv set vrf default router bgp neighbor swp50s0 type unnumbered
nv set vrf default router bgp neighbor swp50s1 peer-group underlay
...
nv set vrf default router bgp neighbor swp52s0 peer-group underlay
nv set vrf default router bgp neighbor swp52s0 type unnumbered
nv set vrf default router bgp neighbor swp52s1 peer-group underlay
...
nv set vrf default router bgp neighbor swp54s0 peer-group underlay
nv set vrf default router bgp neighbor swp54s0 type unnumbered
nv set vrf default router bgp neighbor swp54s1 peer-group underlay
...
nv set vrf default router bgp neighbor swp56s0 peer-group underlay
nv set vrf default router bgp neighbor swp56s0 type unnumbered
nv set vrf default router bgp neighbor swp56s1 peer-group underlay
...
nv set vrf default router bgp router-id 172.16.1.63
