...
# NVUE CLI Configuration for rack-oob-su-02-01
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.105/32
...
nv set nve vxlan source address 172.16.1.105
...
nv set router bgp autonomous-system 4200100006
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.105
...
nv set system hostname rack-oob-su-02-01
...
#       You are successfully logged in to: rack-oob-su-02-01 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.1.125/32
...
nv set vrf OOB router bgp autonomous-system 4200100006
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.1.125
