...
# NVUE CLI Configuration for rack-oob-su-07-01
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.115/32
...
nv set nve vxlan source address 172.16.1.115
...
nv set router bgp autonomous-system 4200100016
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.115
...
nv set system hostname rack-oob-su-07-01
...
#       You are successfully logged in to: rack-oob-su-07-01 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.1.135/32
...
nv set vrf OOB router bgp autonomous-system 4200100016
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.1.135
