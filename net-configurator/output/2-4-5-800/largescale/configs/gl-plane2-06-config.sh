...
nv set interface lo ipv4 address 10.2.1.6/32
...
nv set interface vlan920 ipv4 address 192.168.16.7/20
...
nv set nve vxlan source address 10.2.1.6
...
nv set router bgp router-id 10.2.1.6
...
nv set vrf GPU loopback ip address 10.2.1.26/32
...
nv set vrf GPU router bgp router-id 10.2.1.6
...
nv set vrf default router bgp router-id 10.2.1.6
