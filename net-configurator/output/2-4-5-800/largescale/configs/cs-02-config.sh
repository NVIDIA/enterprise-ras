...
nv set interface lo ipv4 address 172.16.1.62/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4200100503
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.62
...
#       You are successfully logged in to: cs-02 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf default router bgp router-id 172.16.1.62
