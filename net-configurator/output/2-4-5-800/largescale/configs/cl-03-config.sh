...
nv set interface bond1s2 evpn multihoming segment local-id 1009
nv set interface bond1s2 description su-01-node-09
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 1010
nv set interface bond1s3 description su-01-node-10

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 1016
nv set interface bond2s0 description su-01-node-16
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 1017
nv set interface bond2s1 description su-01-node-17
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 2005
nv set interface bond2s2 description su-02-node-05
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 2006
nv set interface bond2s3 description su-02-node-06

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 2012
nv set interface bond3s0 description su-02-node-12
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 2013
nv set interface bond3s1 description su-02-node-13
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 3001
nv set interface bond3s2 description su-03-node-01
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 3002
nv set interface bond3s3 description su-03-node-02

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 3008
nv set interface bond4s0 description su-03-node-08
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 3009
nv set interface bond4s1 description su-03-node-09
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 3015
nv set interface bond4s2 description su-03-node-15
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 3016
nv set interface bond4s3 description su-03-node-16

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 4004
nv set interface bond5s0 description su-04-node-04
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 4005
nv set interface bond5s1 description su-04-node-05
nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 4011
nv set interface bond5s2 description su-04-node-11
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 4012
nv set interface bond5s3 description su-04-node-12

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 4018
nv set interface bond6s0 description su-04-node-18
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 5001
nv set interface bond6s1 description su-05-node-01
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 5007
nv set interface bond6s2 description su-05-node-07
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 5008
nv set interface bond6s3 description su-05-node-08

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 5014
nv set interface bond7s0 description su-05-node-14
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 5015
nv set interface bond7s1 description su-05-node-15
nv set interface bond7s2 bond member swp7s2
nv set interface bond7s2 evpn multihoming segment local-id 6003
nv set interface bond7s2 description su-06-node-03
nv set interface bond7s3 bond member swp7s3
nv set interface bond7s3 evpn multihoming segment local-id 6004
nv set interface bond7s3 description su-06-node-04

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 6010
nv set interface bond8s0 description su-06-node-10
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 6011
nv set interface bond8s1 description su-06-node-11
nv set interface bond8s2 bond member swp8s2
nv set interface bond8s2 evpn multihoming segment local-id 6017
nv set interface bond8s2 description su-06-node-17
nv set interface bond8s3 bond member swp8s3
nv set interface bond8s3 evpn multihoming segment local-id 6018
nv set interface bond8s3 description su-06-node-18

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 7006
nv set interface bond9s0 description su-07-node-06
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 7007
nv set interface bond9s1 description su-07-node-07
nv set interface bond9s2 bond member swp9s2
nv set interface bond9s2 evpn multihoming segment local-id 7013
nv set interface bond9s2 description su-07-node-13
nv set interface bond9s3 bond member swp9s3
nv set interface bond9s3 evpn multihoming segment local-id 7014
nv set interface bond9s3 description su-07-node-14

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 8002
nv set interface bond10s0 description su-08-node-02
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 8003
nv set interface bond10s1 description su-08-node-03
nv set interface bond10s2 bond member swp10s2
nv set interface bond10s2 evpn multihoming segment local-id 8009
nv set interface bond10s2 description su-08-node-09
nv set interface bond10s3 bond member swp10s3
nv set interface bond10s3 evpn multihoming segment local-id 8010
nv set interface bond10s3 description su-08-node-10

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 8016
nv set interface bond11s0 description su-08-node-16
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 8017
nv set interface bond11s1 description su-08-node-17
...
nv set interface bond13s1 evpn multihoming segment local-id 800005
nv set interface bond13s1 description support-05
...
nv set interface bond12s1 evpn multihoming segment local-id 900003
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.7/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.5/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.5/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.3/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.3/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.3/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.5/32
...
nv set vrf INBAND router bgp router-id 172.16.1.5

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.3/32
...
nv set vrf OOB router bgp router-id 172.16.1.3

nv set vrf EXIT evpn state enabled
nv set vrf EXIT evpn vlan 3004
nv set vrf EXIT evpn vni 5004

nv set vrf EXIT loopback ip address 172.16.1.7/32
...
nv set vrf EXIT router bgp router-id 172.16.1.7
...
nv set vrf STORAGE router bgp router-id 172.16.1.13
