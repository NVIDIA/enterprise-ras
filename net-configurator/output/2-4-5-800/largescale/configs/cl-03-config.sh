...
# NVUE CLI Configuration for cl-03
...
#============================================================================
nv set interface swp22,swp23,swp58,swp59,swp60,swp61,swp62 link breakout 4x lanes-per-port 2
nv set interface swp1,swp2,swp3,swp4,swp5,swp6,swp7,swp8,swp9,swp10,swp11,swp12,swp13,swp14,swp15,swp16,swp17,swp18,swp19,swp20,swp21,swp26,swp27,swp28,swp29,swp30,swp31,swp32,swp33,swp34,swp35,swp36,swp37,swp38,swp39,swp40,swp41,swp42,swp43,swp44,swp45,swp46,swp47,swp48,swp49,swp50,swp51,swp52,swp53,swp54,swp55,swp56,swp57 link breakout 2x lanes-per-port 4
nv set interface swp63 link breakout 8x lanes-per-port 1
nv set interface swp63s0,swp63s1,swp63s2,swp63s3,swp63s4 link speed 100G
nv set interface swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3,swp58s0,swp58s1,swp58s2,swp58s3,swp59s0,swp59s1,swp59s2,swp59s3 link speed 200G
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1 link speed 400G
...
nv set interface bond1s0 evpn multihoming segment local-id 1002
nv set interface bond1s0 description su-01-node-02
nv set interface bond1s1 bond member swp1s1
nv set interface bond1s1 evpn multihoming segment local-id 1005
nv set interface bond1s1 description su-01-node-05

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 1009
nv set interface bond2s0 description su-01-node-09
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 1012
nv set interface bond2s1 description su-01-node-12

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 1016
nv set interface bond3s0 description su-01-node-16
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 2001
nv set interface bond3s1 description su-02-node-01

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 2005
nv set interface bond4s0 description su-02-node-05
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 2008
nv set interface bond4s1 description su-02-node-08

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 2012
nv set interface bond5s0 description su-02-node-12
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 2015
nv set interface bond5s1 description su-02-node-15

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 3001
nv set interface bond6s0 description su-03-node-01
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 3004
nv set interface bond6s1 description su-03-node-04

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 3008
nv set interface bond7s0 description su-03-node-08
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 3011
nv set interface bond7s1 description su-03-node-11

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 3015
nv set interface bond8s0 description su-03-node-15
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 3018
nv set interface bond8s1 description su-03-node-18

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 4004
nv set interface bond9s0 description su-04-node-04
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 4007
nv set interface bond9s1 description su-04-node-07

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 4011
nv set interface bond10s0 description su-04-node-11
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 4014
nv set interface bond10s1 description su-04-node-14

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 4018
nv set interface bond11s0 description su-04-node-18
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 5003
nv set interface bond11s1 description su-05-node-03

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 5007
nv set interface bond12s0 description su-05-node-07
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 5010
nv set interface bond12s1 description su-05-node-10

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 5014
nv set interface bond13s0 description su-05-node-14
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 5017
nv set interface bond13s1 description su-05-node-17

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 6003
nv set interface bond14s0 description su-06-node-03
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 6006
nv set interface bond14s1 description su-06-node-06

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 6010
nv set interface bond15s0 description su-06-node-10
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 6013
nv set interface bond15s1 description su-06-node-13

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 6017
nv set interface bond16s0 description su-06-node-17
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 7002
nv set interface bond16s1 description su-07-node-02

nv set interface bond17s0 bond member swp17s0
nv set interface bond17s0 evpn multihoming segment local-id 7006
nv set interface bond17s0 description su-07-node-06
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 7009
nv set interface bond17s1 description su-07-node-09

nv set interface bond18s0 bond member swp18s0
nv set interface bond18s0 evpn multihoming segment local-id 7013
nv set interface bond18s0 description su-07-node-13
nv set interface bond18s1 bond member swp18s1
nv set interface bond18s1 evpn multihoming segment local-id 7016
nv set interface bond18s1 description su-07-node-16

nv set interface bond19s0 bond member swp19s0
nv set interface bond19s0 evpn multihoming segment local-id 8002
nv set interface bond19s0 description su-08-node-02
nv set interface bond19s1 bond member swp19s1
nv set interface bond19s1 evpn multihoming segment local-id 8005
nv set interface bond19s1 description su-08-node-05

nv set interface bond20s0 bond member swp20s0
nv set interface bond20s0 evpn multihoming segment local-id 8009
nv set interface bond20s0 description su-08-node-09
nv set interface bond20s1 bond member swp20s1
nv set interface bond20s1 evpn multihoming segment local-id 8012
nv set interface bond20s1 description su-08-node-12

nv set interface bond21s0 bond member swp21s0
nv set interface bond21s0 evpn multihoming segment local-id 8016
nv set interface bond21s0 description su-08-node-16

# CPU role - 21 ports, 41 bonds
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 evpn multihoming segment state enabled
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 type bond
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 bridge domain br_default vlan 300,400
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 bridge domain br_default untagged 300
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0 bond lacp-bypass enabled

nv set interface bond22s0 bond member swp22s0
nv set interface bond22s0 evpn multihoming segment local-id 800002
nv set interface bond22s0 description support-02
nv set interface bond22s1 bond member swp22s1
nv set interface bond22s1 evpn multihoming segment local-id 1800002
nv set interface bond22s1 description support-02
nv set interface bond22s2 bond member swp22s2
nv set interface bond22s2 evpn multihoming segment local-id 800005
nv set interface bond22s2 description support-05
nv set interface bond22s3 bond member swp22s3
nv set interface bond22s3 evpn multihoming segment local-id 1800005
nv set interface bond22s3 description support-05

nv set interface bond23s0 bond member swp23s0
nv set interface bond23s0 evpn multihoming segment local-id 800009
nv set interface bond23s0 description support-09
nv set interface bond23s1 bond member swp23s1
nv set interface bond23s1 evpn multihoming segment local-id 1800009
nv set interface bond23s1 description support-09
nv set interface bond23s2 bond member swp23s2
nv set interface bond23s2 evpn multihoming segment local-id 800012
nv set interface bond23s2 description support-12
nv set interface bond23s3 bond member swp23s3
nv set interface bond23s3 evpn multihoming segment local-id 1800012
nv set interface bond23s3 description support-12

# SUPPORT role - 2 ports, 8 bonds
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 evpn multihoming segment state enabled
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 type bond
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 bridge domain br_default vlan 200,300,400
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 bridge domain br_default untagged 300
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1,bond23s2,bond23s3 bond lacp-bypass enabled
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.13/32
...
nv set interface swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1 description isl_to_peer_core_switch
nv set interface swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1 evpn multihoming uplink enabled

# EDGE role - direct interfaces
nv set interface swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 description edge_uplink
nv set interface swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 vrf EXIT

# OOB role - direct L3 uplinks
nv set interface swp63s0,swp63s1,swp63s2,swp63s3,swp63s4 description oob_uplink

# STORAGE role - L3 external uplinks
nv set interface swp58s0,swp59s0,swp59s1,swp59s2,swp59s3 description external_uplink_storage_vrf
nv set interface swp58s0,swp59s0,swp59s1,swp59s2,swp59s3 vrf STORAGE
...
nv set interface swp24,swp25,swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 type swp

nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 telemetry histogram counter counter-type rx-packet
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 telemetry histogram counter counter-type tx-packet
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 telemetry histogram egress-buffer traffic-class 0
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 telemetry histogram ingress-buffer priority-group 0
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 telemetry histogram ingress-buffer priority-group 1

#============================================================================
# VLAN SVIs (from host_vars)
#============================================================================
nv set interface vlan300 ipv4 address 172.16.178.4/24
...
nv set interface vlan400 ipv4 address 172.16.179.4/24
...
nv set nve vxlan source address 172.16.1.13

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4200100404
nv set router bgp router-id 172.16.1.13
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.185/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.169/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 match 172.16.178.4/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 match 172.16.179.4/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.169/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.153/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.153/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.153/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.169/32
...
nv set vrf EXIT router bgp autonomous-system 4200100404
nv set vrf EXIT router bgp state enabled

nv set vrf EXIT router bgp neighbor swp60s0 peer-group exit
nv set vrf EXIT router bgp neighbor swp60s0 type unnumbered
nv set vrf EXIT router bgp neighbor swp60s1 peer-group exit
nv set vrf EXIT router bgp neighbor swp60s1 type unnumbered
...
nv set vrf EXIT router bgp router-id 172.16.1.185

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.1.201/32
...
nv set vrf STORAGE router bgp autonomous-system 4200100404
...
nv set vrf STORAGE router bgp router-id 172.16.1.201
...
nv set vrf default router bgp neighbor swp63s4 peer-group underlay
nv set vrf default router bgp neighbor swp63s4 type unnumbered
...
#       You are successfully logged in to: cl-03 - site: largescale / arch: 2-4-5-800
####################################################################'
