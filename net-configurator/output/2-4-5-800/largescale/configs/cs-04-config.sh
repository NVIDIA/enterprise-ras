...
# NVUE CLI Configuration for cs-04
...
nv set interface lo ipv4 address 172.16.1.64/32
...
# BGP Global
#============================================================================
nv set router bgp autonomous-system 4200100505
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.64
...
#       You are successfully logged in to: cs-04 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf default router bgp router-id 172.16.1.64
