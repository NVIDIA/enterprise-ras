...
nv set interface lo ipv4 address 10.2.1.8/32
...
nv set interface vlan920 ipv4 address 192.168.16.9/20
...
nv set nve vxlan source address 10.2.1.8
...
nv set router bgp router-id 10.2.1.8
...
nv set vrf GPU loopback ip address 10.2.1.28/32
...
nv set vrf GPU router bgp router-id 10.2.1.8
...
nv set vrf default router bgp router-id 10.2.1.8
