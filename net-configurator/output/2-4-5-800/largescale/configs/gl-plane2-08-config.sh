...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102108
...
#       You are successfully logged in to: gl-plane2-08 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU router bgp autonomous-system 4200102108
...
nv set vrf default router bgp autonomous-system 4200102108
