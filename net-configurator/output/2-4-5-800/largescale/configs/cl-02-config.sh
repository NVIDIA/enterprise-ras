...
nv set interface bond1s3 evpn multihoming segment local-id 1009
nv set interface bond1s3 description su-01-node-09
...
nv set interface bond2s1 evpn multihoming segment local-id 1016
nv set interface bond2s1 description su-01-node-16
...
nv set interface bond2s3 evpn multihoming segment local-id 2005
nv set interface bond2s3 description su-02-node-05
...
nv set interface bond3s1 evpn multihoming segment local-id 2012
nv set interface bond3s1 description su-02-node-12
...
nv set interface bond3s3 evpn multihoming segment local-id 3001
nv set interface bond3s3 description su-03-node-01
...
nv set interface bond4s1 evpn multihoming segment local-id 3008
nv set interface bond4s1 description su-03-node-08
...
nv set interface bond4s3 evpn multihoming segment local-id 3015
nv set interface bond4s3 description su-03-node-15
...
nv set interface bond5s1 evpn multihoming segment local-id 4004
nv set interface bond5s1 description su-04-node-04
...
nv set interface bond5s3 evpn multihoming segment local-id 4011
nv set interface bond5s3 description su-04-node-11
...
nv set interface bond6s1 evpn multihoming segment local-id 4018
nv set interface bond6s1 description su-04-node-18
...
nv set interface bond6s3 evpn multihoming segment local-id 5007
nv set interface bond6s3 description su-05-node-07
...
nv set interface bond7s1 evpn multihoming segment local-id 5014
nv set interface bond7s1 description su-05-node-14
...
nv set interface bond7s3 evpn multihoming segment local-id 6003
nv set interface bond7s3 description su-06-node-03
...
nv set interface bond8s1 evpn multihoming segment local-id 6010
nv set interface bond8s1 description su-06-node-10
...
nv set interface bond8s3 evpn multihoming segment local-id 6017
nv set interface bond8s3 description su-06-node-17
...
nv set interface bond9s1 evpn multihoming segment local-id 7006
nv set interface bond9s1 description su-07-node-06
...
nv set interface bond9s3 evpn multihoming segment local-id 7013
nv set interface bond9s3 description su-07-node-13
...
nv set interface bond10s1 evpn multihoming segment local-id 8002
nv set interface bond10s1 description su-08-node-02
...
nv set interface bond10s3 evpn multihoming segment local-id 8009
nv set interface bond10s3 description su-08-node-09
...
nv set interface bond11s1 evpn multihoming segment local-id 8016
nv set interface bond11s1 description su-08-node-16
...
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.4/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.4/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.2/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.2/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.2/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.4/32
...
nv set vrf INBAND router bgp router-id 172.16.1.4

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.2/32
...
nv set vrf OOB router bgp router-id 172.16.1.2
...
nv set vrf STORAGE router bgp router-id 172.16.1.12
