...
# NVUE CLI Configuration for cl-02
...
nv set router bgp autonomous-system 4200100403
...
nv set vrf INBAND router bgp autonomous-system 4200100403
...
nv set vrf OOB router bgp autonomous-system 4200100403
...
nv set vrf EXIT router bgp autonomous-system 4200100403
...
nv set vrf STORAGE router bgp autonomous-system 4200100403
...
#       You are successfully logged in to: cl-02 - site: largescale / arch: 2-4-5-800
####################################################################'
