...
# NVUE CLI Configuration for cl-07
...
nv set interface bond1s0 evpn multihoming segment local-id 1004
nv set interface bond1s0 description su-01-node-04
...
nv set interface bond2s0 evpn multihoming segment local-id 1011
nv set interface bond2s0 description su-01-node-11
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 1014
nv set interface bond2s1 description su-01-node-14

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 1018
nv set interface bond3s0 description su-01-node-18
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 2003
nv set interface bond3s1 description su-02-node-03

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 2007
nv set interface bond4s0 description su-02-node-07
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 2010
nv set interface bond4s1 description su-02-node-10

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 2014
nv set interface bond5s0 description su-02-node-14
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 2017
nv set interface bond5s1 description su-02-node-17

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 3003
nv set interface bond6s0 description su-03-node-03
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 3006
nv set interface bond6s1 description su-03-node-06

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 3010
nv set interface bond7s0 description su-03-node-10
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 3013
nv set interface bond7s1 description su-03-node-13

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 3017
nv set interface bond8s0 description su-03-node-17
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 4002
nv set interface bond8s1 description su-04-node-02

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 4006
nv set interface bond9s0 description su-04-node-06
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 4009
nv set interface bond9s1 description su-04-node-09

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 4013
nv set interface bond10s0 description su-04-node-13
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 4016
nv set interface bond10s1 description su-04-node-16

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 5002
nv set interface bond11s0 description su-05-node-02
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 5005
nv set interface bond11s1 description su-05-node-05

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 5009
nv set interface bond12s0 description su-05-node-09
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 5012
nv set interface bond12s1 description su-05-node-12

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 5016
nv set interface bond13s0 description su-05-node-16
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 6001
nv set interface bond13s1 description su-06-node-01

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 6005
nv set interface bond14s0 description su-06-node-05
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 6008
nv set interface bond14s1 description su-06-node-08

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 6012
nv set interface bond15s0 description su-06-node-12
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 6015
nv set interface bond15s1 description su-06-node-15

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 7001
nv set interface bond16s0 description su-07-node-01
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 7004
nv set interface bond16s1 description su-07-node-04

nv set interface bond17s0 bond member swp17s0
nv set interface bond17s0 evpn multihoming segment local-id 7008
nv set interface bond17s0 description su-07-node-08
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 7011
nv set interface bond17s1 description su-07-node-11

nv set interface bond18s0 bond member swp18s0
nv set interface bond18s0 evpn multihoming segment local-id 7015
nv set interface bond18s0 description su-07-node-15
nv set interface bond18s1 bond member swp18s1
nv set interface bond18s1 evpn multihoming segment local-id 7018
nv set interface bond18s1 description su-07-node-18

nv set interface bond19s0 bond member swp19s0
nv set interface bond19s0 evpn multihoming segment local-id 8004
nv set interface bond19s0 description su-08-node-04
nv set interface bond19s1 bond member swp19s1
nv set interface bond19s1 evpn multihoming segment local-id 8007
nv set interface bond19s1 description su-08-node-07

nv set interface bond20s0 bond member swp20s0
nv set interface bond20s0 evpn multihoming segment local-id 8011
nv set interface bond20s0 description su-08-node-11
nv set interface bond20s1 bond member swp20s1
nv set interface bond20s1 evpn multihoming segment local-id 8014
nv set interface bond20s1 description su-08-node-14

nv set interface bond21s0 bond member swp21s0
nv set interface bond21s0 evpn multihoming segment local-id 8018
nv set interface bond21s0 description su-08-node-18
...
nv set interface bond22s0 evpn multihoming segment local-id 800004
nv set interface bond22s0 description support-04
nv set interface bond22s1 bond member swp22s1
nv set interface bond22s1 evpn multihoming segment local-id 1800004
nv set interface bond22s1 description support-04
nv set interface bond22s2 bond member swp22s2
nv set interface bond22s2 evpn multihoming segment local-id 800007
nv set interface bond22s2 description support-07
nv set interface bond22s3 bond member swp22s3
nv set interface bond22s3 evpn multihoming segment local-id 1800007
nv set interface bond22s3 description support-07

nv set interface bond23s0 bond member swp23s0
nv set interface bond23s0 evpn multihoming segment local-id 800011
nv set interface bond23s0 description support-11
nv set interface bond23s1 bond member swp23s1
nv set interface bond23s1 evpn multihoming segment local-id 1800011
nv set interface bond23s1 description support-11
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.17/32
...
#============================================================================
nv set interface vlan300 ipv4 address 172.16.178.8/24
...
nv set interface vlan400 ipv4 address 172.16.179.8/24
...
nv set nve vxlan source address 172.16.1.17

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4200100408
nv set router bgp router-id 172.16.1.17
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.189/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.173/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 match 172.16.178.8/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 match 172.16.179.8/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.173/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.157/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.157/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.157/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.173/32
...
nv set vrf EXIT router bgp autonomous-system 4200100408
...
nv set vrf EXIT router bgp router-id 172.16.1.189

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.1.205/32
...
nv set vrf STORAGE router bgp autonomous-system 4200100408
...
nv set vrf STORAGE router bgp router-id 172.16.1.205
...
#       You are successfully logged in to: cl-07 - site: largescale / arch: 2-4-5-800
####################################################################'
