...
nv set interface bond1s0 evpn multihoming segment local-id 1006
nv set interface bond1s0 description su-01-node-06
...
nv set interface bond1s2 evpn multihoming segment local-id 1013
nv set interface bond1s2 description su-01-node-13
...
nv set interface bond2s0 evpn multihoming segment local-id 2002
nv set interface bond2s0 description su-02-node-02
...
nv set interface bond2s2 evpn multihoming segment local-id 2009
nv set interface bond2s2 description su-02-node-09
...
nv set interface bond3s0 evpn multihoming segment local-id 2016
nv set interface bond3s0 description su-02-node-16
...
nv set interface bond3s2 evpn multihoming segment local-id 3005
nv set interface bond3s2 description su-03-node-05
...
nv set interface bond4s0 evpn multihoming segment local-id 3012
nv set interface bond4s0 description su-03-node-12
...
nv set interface bond4s2 evpn multihoming segment local-id 4001
nv set interface bond4s2 description su-04-node-01
...
nv set interface bond5s0 evpn multihoming segment local-id 4008
nv set interface bond5s0 description su-04-node-08
...
nv set interface bond5s2 evpn multihoming segment local-id 4015
nv set interface bond5s2 description su-04-node-15
...
nv set interface bond6s0 evpn multihoming segment local-id 5004
nv set interface bond6s0 description su-05-node-04
...
nv set interface bond6s2 evpn multihoming segment local-id 5011
nv set interface bond6s2 description su-05-node-11
...
nv set interface bond7s0 evpn multihoming segment local-id 5018
nv set interface bond7s0 description su-05-node-18
...
nv set interface bond7s2 evpn multihoming segment local-id 6007
nv set interface bond7s2 description su-06-node-07
...
nv set interface bond8s0 evpn multihoming segment local-id 6014
nv set interface bond8s0 description su-06-node-14
...
nv set interface bond8s2 evpn multihoming segment local-id 7003
nv set interface bond8s2 description su-07-node-03
...
nv set interface bond9s0 evpn multihoming segment local-id 7010
nv set interface bond9s0 description su-07-node-10
...
nv set interface bond9s2 evpn multihoming segment local-id 7017
nv set interface bond9s2 description su-07-node-17
...
nv set interface bond10s0 evpn multihoming segment local-id 8006
nv set interface bond10s0 description su-08-node-06
...
nv set interface bond10s2 evpn multihoming segment local-id 8013
nv set interface bond10s2 description su-08-node-13
...
nv set interface bond13s0 evpn multihoming segment local-id 800004
nv set interface bond13s0 description support-04
...
nv set interface bond12s0 evpn multihoming segment local-id 1900002
...
nv set interface bond12s0,bond12s1 evpn multihoming segment state enabled
nv set interface bond12s0,bond12s1 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond12s0,bond12s1 type bond
nv set interface bond12s0,bond12s1 bridge domain br_default vlan 400,500
nv set interface bond12s0,bond12s1 bridge domain br_default untagged 300
nv set interface bond12s0,bond12s1 bond lacp-bypass enabled
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.11/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.9/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.9/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.7/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.7/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.7/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.9/32
...
nv set vrf INBAND router bgp router-id 172.16.1.9

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.7/32
...
nv set vrf OOB router bgp router-id 172.16.1.7

nv set vrf EXIT evpn state enabled
nv set vrf EXIT evpn vlan 3004
nv set vrf EXIT evpn vni 5004

nv set vrf EXIT loopback ip address 172.16.1.11/32
...
nv set vrf EXIT router bgp router-id 172.16.1.11
...
nv set vrf STORAGE router bgp router-id 172.16.1.17
