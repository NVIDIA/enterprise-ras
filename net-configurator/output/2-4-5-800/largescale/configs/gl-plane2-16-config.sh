...
nv set interface lo ipv4 address 10.2.1.16/32
...
nv set interface vlan920 ipv4 address 192.168.16.17/20
...
nv set nve vxlan source address 10.2.1.16
...
nv set router bgp router-id 10.2.1.16
...
nv set vrf GPU loopback ip address 10.2.1.36/32
...
nv set vrf GPU router bgp router-id 10.2.1.16
...
nv set vrf default router bgp router-id 10.2.1.16
