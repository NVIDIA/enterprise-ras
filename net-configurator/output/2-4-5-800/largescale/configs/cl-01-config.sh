...
nv set interface bond1s1 evpn multihoming segment local-id 1004
nv set interface bond1s1 description su-01-node-04

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 1008
nv set interface bond2s0 description su-01-node-08
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 1011
nv set interface bond2s1 description su-01-node-11

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 1015
nv set interface bond3s0 description su-01-node-15
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 1018
nv set interface bond3s1 description su-01-node-18

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 2004
nv set interface bond4s0 description su-02-node-04
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 2007
nv set interface bond4s1 description su-02-node-07

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 2011
nv set interface bond5s0 description su-02-node-11
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 2014
nv set interface bond5s1 description su-02-node-14

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 2018
nv set interface bond6s0 description su-02-node-18
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 3003
nv set interface bond6s1 description su-03-node-03

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 3007
nv set interface bond7s0 description su-03-node-07
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 3010
nv set interface bond7s1 description su-03-node-10

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 3014
nv set interface bond8s0 description su-03-node-14
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 3017
nv set interface bond8s1 description su-03-node-17

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 4003
nv set interface bond9s0 description su-04-node-03
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 4006
nv set interface bond9s1 description su-04-node-06

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 4010
nv set interface bond10s0 description su-04-node-10
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 4013
nv set interface bond10s1 description su-04-node-13

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 4017
nv set interface bond11s0 description su-04-node-17
nv set interface bond11s1 bond member swp11s1
nv set interface bond11s1 evpn multihoming segment local-id 5002
nv set interface bond11s1 description su-05-node-02

nv set interface bond12s0 bond member swp12s0
nv set interface bond12s0 evpn multihoming segment local-id 5006
nv set interface bond12s0 description su-05-node-06
nv set interface bond12s1 bond member swp12s1
nv set interface bond12s1 evpn multihoming segment local-id 5009
nv set interface bond12s1 description su-05-node-09

nv set interface bond13s0 bond member swp13s0
nv set interface bond13s0 evpn multihoming segment local-id 5013
nv set interface bond13s0 description su-05-node-13
nv set interface bond13s1 bond member swp13s1
nv set interface bond13s1 evpn multihoming segment local-id 5016
nv set interface bond13s1 description su-05-node-16

nv set interface bond14s0 bond member swp14s0
nv set interface bond14s0 evpn multihoming segment local-id 6002
nv set interface bond14s0 description su-06-node-02
nv set interface bond14s1 bond member swp14s1
nv set interface bond14s1 evpn multihoming segment local-id 6005
nv set interface bond14s1 description su-06-node-05

nv set interface bond15s0 bond member swp15s0
nv set interface bond15s0 evpn multihoming segment local-id 6009
nv set interface bond15s0 description su-06-node-09
nv set interface bond15s1 bond member swp15s1
nv set interface bond15s1 evpn multihoming segment local-id 6012
nv set interface bond15s1 description su-06-node-12

nv set interface bond16s0 bond member swp16s0
nv set interface bond16s0 evpn multihoming segment local-id 6016
nv set interface bond16s0 description su-06-node-16
nv set interface bond16s1 bond member swp16s1
nv set interface bond16s1 evpn multihoming segment local-id 7001
nv set interface bond16s1 description su-07-node-01

nv set interface bond17s0 bond member swp17s0
nv set interface bond17s0 evpn multihoming segment local-id 7005
nv set interface bond17s0 description su-07-node-05
nv set interface bond17s1 bond member swp17s1
nv set interface bond17s1 evpn multihoming segment local-id 7008
nv set interface bond17s1 description su-07-node-08

nv set interface bond18s0 bond member swp18s0
nv set interface bond18s0 evpn multihoming segment local-id 7012
nv set interface bond18s0 description su-07-node-12
nv set interface bond18s1 bond member swp18s1
nv set interface bond18s1 evpn multihoming segment local-id 7015
nv set interface bond18s1 description su-07-node-15

nv set interface bond19s0 bond member swp19s0
nv set interface bond19s0 evpn multihoming segment local-id 8001
nv set interface bond19s0 description su-08-node-01
nv set interface bond19s1 bond member swp19s1
nv set interface bond19s1 evpn multihoming segment local-id 8004
nv set interface bond19s1 description su-08-node-04

nv set interface bond20s0 bond member swp20s0
nv set interface bond20s0 evpn multihoming segment local-id 8008
nv set interface bond20s0 description su-08-node-08
nv set interface bond20s1 bond member swp20s1
nv set interface bond20s1 evpn multihoming segment local-id 8011
nv set interface bond20s1 description su-08-node-11

nv set interface bond21s0 bond member swp21s0
nv set interface bond21s0 evpn multihoming segment local-id 8015
nv set interface bond21s0 description su-08-node-15
nv set interface bond21s1 bond member swp21s1
nv set interface bond21s1 evpn multihoming segment local-id 8018
nv set interface bond21s1 description su-08-node-18

# CPU role - 21 ports, 42 bonds
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 evpn multihoming segment state enabled
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 type bond
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 bridge domain br_default vlan 300,400
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 bridge domain br_default untagged 300
nv set interface bond1s0,bond1s1,bond2s0,bond2s1,bond3s0,bond3s1,bond4s0,bond4s1,bond5s0,bond5s1,bond6s0,bond6s1,bond7s0,bond7s1,bond8s0,bond8s1,bond9s0,bond9s1,bond10s0,bond10s1,bond11s0,bond11s1,bond12s0,bond12s1,bond13s0,bond13s1,bond14s0,bond14s1,bond15s0,bond15s1,bond16s0,bond16s1,bond17s0,bond17s1,bond18s0,bond18s1,bond19s0,bond19s1,bond20s0,bond20s1,bond21s0,bond21s1 bond lacp-bypass enabled

nv set interface bond22s0 bond member swp22s0
nv set interface bond22s0 evpn multihoming segment local-id 800001
nv set interface bond22s0 description support-01
nv set interface bond22s1 bond member swp22s1
nv set interface bond22s1 evpn multihoming segment local-id 1800001
nv set interface bond22s1 description support-01
nv set interface bond22s2 bond member swp22s2
nv set interface bond22s2 evpn multihoming segment local-id 800004
nv set interface bond22s2 description support-04
nv set interface bond22s3 bond member swp22s3
nv set interface bond22s3 evpn multihoming segment local-id 1800004
nv set interface bond22s3 description support-04

nv set interface bond23s0 bond member swp23s0
nv set interface bond23s0 evpn multihoming segment local-id 800008
nv set interface bond23s0 description support-08
nv set interface bond23s1 bond member swp23s1
nv set interface bond23s1 evpn multihoming segment local-id 1800008
nv set interface bond23s1 description support-08
nv set interface bond23s2 bond member swp23s2
nv set interface bond23s2 evpn multihoming segment local-id 800011
nv set interface bond23s2 description support-11
nv set interface bond23s3 bond member swp23s3
nv set interface bond23s3 evpn multihoming segment local-id 1800011
nv set interface bond23s3 description support-11
...
nv set interface swp60s0,swp60s1,swp60s2,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 description edge_uplink
nv set interface swp60s0,swp60s1,swp60s2,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 vrf EXIT

# OOB role - direct L3 uplinks
nv set interface swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp63s5,swp63s6 description oob_uplink

# STORAGE role - L3 external uplinks
nv set interface swp58s0,swp58s1,swp59s0,swp59s1,swp59s2,swp59s3 description external_uplink_storage_vrf
nv set interface swp58s0,swp58s1,swp59s0,swp59s1,swp59s2,swp59s3 vrf STORAGE
...
nv set interface swp24,swp25,swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp21s1,swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp23s2,swp23s3,swp26s0,swp26s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1,swp48s0,swp48s1,swp49s0,swp49s1,swp50s0,swp50s1,swp51s0,swp51s1,swp52s0,swp52s1,swp53s0,swp53s1,swp54s0,swp54s1,swp55s0,swp55s1,swp56s0,swp56s1,swp57s0,swp57s1,swp63s0,swp63s1,swp63s2,swp63s3,swp63s4,swp63s5,swp63s6,swp60s0,swp60s1,swp60s2,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3 type swp
...
nv set nve vxlan source address 172.16.1.11
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.183/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.167/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.167/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.151/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.151/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.151/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.167/32
...
nv set vrf INBAND router bgp router-id 172.16.1.167

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.151/32
...
nv set vrf OOB router bgp router-id 172.16.1.151

nv set vrf EXIT evpn state enabled
nv set vrf EXIT evpn vlan 3004
nv set vrf EXIT evpn vni 5004

nv set vrf EXIT loopback ip address 172.16.1.183/32
...
nv set vrf EXIT router bgp neighbor swp60s2 peer-group exit
nv set vrf EXIT router bgp neighbor swp60s2 type unnumbered
...
nv set vrf EXIT router bgp router-id 172.16.1.183

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.1.199/32
...
nv set vrf STORAGE router bgp router-id 172.16.1.199
...
nv set vrf default router bgp neighbor swp63s5 peer-group underlay
nv set vrf default router bgp neighbor swp63s5 type unnumbered
nv set vrf default router bgp neighbor swp63s6 peer-group underlay
nv set vrf default router bgp neighbor swp63s6 type unnumbered
