...
nv set interface lo ipv4 address 10.2.1.7/32
...
nv set interface vlan920 ipv4 address 192.168.16.8/20
...
nv set nve vxlan source address 10.2.1.7
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102107
nv set router bgp state enabled
nv set router bgp router-id 10.2.1.7
...
#       You are successfully logged in to: gl-plane2-07 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.2.1.27/32
...
nv set vrf GPU router bgp autonomous-system 4200102107
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.2.1.7
...
nv set vrf default router bgp autonomous-system 4200102107
...
nv set vrf default router bgp router-id 10.2.1.7
