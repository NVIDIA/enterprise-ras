...
nv set interface lo ipv4 address 10.2.1.13/32
...
nv set interface vlan920 ipv4 address 192.168.16.14/20
...
nv set nve vxlan source address 10.2.1.13
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102113
nv set router bgp state enabled
nv set router bgp router-id 10.2.1.13
...
#       You are successfully logged in to: gl-plane2-13 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.2.1.33/32
...
nv set vrf GPU router bgp autonomous-system 4200102113
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.2.1.13
...
nv set vrf default router bgp autonomous-system 4200102113
...
nv set vrf default router bgp router-id 10.2.1.13
