...
nv set interface bond1s2 evpn multihoming segment local-id 1011
nv set interface bond1s2 description su-01-node-11
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 1012
nv set interface bond1s3 description su-01-node-12

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 1018
nv set interface bond2s0 description su-01-node-18
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 2001
nv set interface bond2s1 description su-02-node-01
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 2007
nv set interface bond2s2 description su-02-node-07
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 2008
nv set interface bond2s3 description su-02-node-08

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 2014
nv set interface bond3s0 description su-02-node-14
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 2015
nv set interface bond3s1 description su-02-node-15
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 3003
nv set interface bond3s2 description su-03-node-03
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 3004
nv set interface bond3s3 description su-03-node-04

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 3010
nv set interface bond4s0 description su-03-node-10
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 3011
nv set interface bond4s1 description su-03-node-11
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 3017
nv set interface bond4s2 description su-03-node-17
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 3018
nv set interface bond4s3 description su-03-node-18

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 4006
nv set interface bond5s0 description su-04-node-06
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 4007
nv set interface bond5s1 description su-04-node-07
nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 4013
nv set interface bond5s2 description su-04-node-13
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 4014
nv set interface bond5s3 description su-04-node-14

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 5002
nv set interface bond6s0 description su-05-node-02
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 5003
nv set interface bond6s1 description su-05-node-03
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 5009
nv set interface bond6s2 description su-05-node-09
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 5010
nv set interface bond6s3 description su-05-node-10

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 5016
nv set interface bond7s0 description su-05-node-16
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 5017
nv set interface bond7s1 description su-05-node-17
nv set interface bond7s2 bond member swp7s2
nv set interface bond7s2 evpn multihoming segment local-id 6005
nv set interface bond7s2 description su-06-node-05
nv set interface bond7s3 bond member swp7s3
nv set interface bond7s3 evpn multihoming segment local-id 6006
nv set interface bond7s3 description su-06-node-06

nv set interface bond8s0 bond member swp8s0
nv set interface bond8s0 evpn multihoming segment local-id 6012
nv set interface bond8s0 description su-06-node-12
nv set interface bond8s1 bond member swp8s1
nv set interface bond8s1 evpn multihoming segment local-id 6013
nv set interface bond8s1 description su-06-node-13
nv set interface bond8s2 bond member swp8s2
nv set interface bond8s2 evpn multihoming segment local-id 7001
nv set interface bond8s2 description su-07-node-01
nv set interface bond8s3 bond member swp8s3
nv set interface bond8s3 evpn multihoming segment local-id 7002
nv set interface bond8s3 description su-07-node-02

nv set interface bond9s0 bond member swp9s0
nv set interface bond9s0 evpn multihoming segment local-id 7008
nv set interface bond9s0 description su-07-node-08
nv set interface bond9s1 bond member swp9s1
nv set interface bond9s1 evpn multihoming segment local-id 7009
nv set interface bond9s1 description su-07-node-09
nv set interface bond9s2 bond member swp9s2
nv set interface bond9s2 evpn multihoming segment local-id 7015
nv set interface bond9s2 description su-07-node-15
nv set interface bond9s3 bond member swp9s3
nv set interface bond9s3 evpn multihoming segment local-id 7016
nv set interface bond9s3 description su-07-node-16

nv set interface bond10s0 bond member swp10s0
nv set interface bond10s0 evpn multihoming segment local-id 8004
nv set interface bond10s0 description su-08-node-04
nv set interface bond10s1 bond member swp10s1
nv set interface bond10s1 evpn multihoming segment local-id 8005
nv set interface bond10s1 description su-08-node-05
nv set interface bond10s2 bond member swp10s2
nv set interface bond10s2 evpn multihoming segment local-id 8011
nv set interface bond10s2 description su-08-node-11
nv set interface bond10s3 bond member swp10s3
nv set interface bond10s3 evpn multihoming segment local-id 8012
nv set interface bond10s3 description su-08-node-12

nv set interface bond11s0 bond member swp11s0
nv set interface bond11s0 evpn multihoming segment local-id 8018
nv set interface bond11s0 description su-08-node-18
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.9/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.7/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.7/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.5/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.5/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.5/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.7/32
...
nv set vrf INBAND router bgp router-id 172.16.1.7

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.5/32
...
nv set vrf OOB router bgp router-id 172.16.1.5

nv set vrf EXIT evpn state enabled
nv set vrf EXIT evpn vlan 3004
nv set vrf EXIT evpn vni 5004

nv set vrf EXIT loopback ip address 172.16.1.9/32
...
nv set vrf EXIT router bgp router-id 172.16.1.9
...
nv set vrf STORAGE router bgp router-id 172.16.1.15
