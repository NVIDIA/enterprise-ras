...
# NVUE CLI Configuration for cl-05
...
nv set interface bond1s0 evpn multihoming segment local-id 1003
nv set interface bond1s0 description su-01-node-03
...
nv set interface bond2s0 evpn multihoming segment local-id 1010
nv set interface bond2s0 description su-01-node-10
...
nv set interface bond3s0 evpn multihoming segment local-id 1017
nv set interface bond3s0 description su-01-node-17
...
nv set interface bond4s0 evpn multihoming segment local-id 2006
nv set interface bond4s0 description su-02-node-06
...
nv set interface bond5s0 evpn multihoming segment local-id 2013
nv set interface bond5s0 description su-02-node-13
...
nv set interface bond6s0 evpn multihoming segment local-id 3002
nv set interface bond6s0 description su-03-node-02
...
nv set interface bond7s0 evpn multihoming segment local-id 3009
nv set interface bond7s0 description su-03-node-09
...
nv set interface bond8s0 evpn multihoming segment local-id 3016
nv set interface bond8s0 description su-03-node-16
...
nv set interface bond9s0 evpn multihoming segment local-id 4005
nv set interface bond9s0 description su-04-node-05
...
nv set interface bond10s0 evpn multihoming segment local-id 4012
nv set interface bond10s0 description su-04-node-12
...
nv set interface bond11s0 evpn multihoming segment local-id 5001
nv set interface bond11s0 description su-05-node-01
...
nv set interface bond12s0 evpn multihoming segment local-id 5008
nv set interface bond12s0 description su-05-node-08
...
nv set interface bond13s0 evpn multihoming segment local-id 5015
nv set interface bond13s0 description su-05-node-15
...
nv set interface bond14s0 evpn multihoming segment local-id 6004
nv set interface bond14s0 description su-06-node-04
...
nv set interface bond15s0 evpn multihoming segment local-id 6011
nv set interface bond15s0 description su-06-node-11
...
nv set interface bond16s0 evpn multihoming segment local-id 6018
nv set interface bond16s0 description su-06-node-18
...
nv set interface bond17s0 evpn multihoming segment local-id 7007
nv set interface bond17s0 description su-07-node-07
...
nv set interface bond18s0 evpn multihoming segment local-id 7014
nv set interface bond18s0 description su-07-node-14
...
nv set interface bond19s0 evpn multihoming segment local-id 8003
nv set interface bond19s0 description su-08-node-03
...
nv set interface bond20s0 evpn multihoming segment local-id 8010
nv set interface bond20s0 description su-08-node-10
...
nv set interface bond21s0 evpn multihoming segment local-id 8017
nv set interface bond21s0 description su-08-node-17
...
nv set interface bond22s0 evpn multihoming segment local-id 800003
nv set interface bond22s0 description support-03
nv set interface bond22s1 bond member swp22s1
nv set interface bond22s1 evpn multihoming segment local-id 1800003
nv set interface bond22s1 description support-03
...
nv set interface bond23s0 evpn multihoming segment local-id 800010
nv set interface bond23s0 description support-10
nv set interface bond23s1 bond member swp23s1
nv set interface bond23s1 evpn multihoming segment local-id 1800010
nv set interface bond23s1 description support-10
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.15/32
...
#============================================================================
nv set interface vlan300 ipv4 address 172.16.178.6/24
...
nv set interface vlan400 ipv4 address 172.16.179.6/24
...
nv set nve vxlan source address 172.16.1.15

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4200100406
nv set router bgp router-id 172.16.1.15
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.187/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.171/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 match 172.16.178.6/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 match 172.16.179.6/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.171/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.155/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.155/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.155/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.171/32
...
nv set vrf EXIT router bgp autonomous-system 4200100406
...
nv set vrf EXIT router bgp router-id 172.16.1.187

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.1.203/32
...
nv set vrf STORAGE router bgp autonomous-system 4200100406
...
nv set vrf STORAGE router bgp router-id 172.16.1.203
...
#       You are successfully logged in to: cl-05 - site: largescale / arch: 2-4-5-800
####################################################################'
