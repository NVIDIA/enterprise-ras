...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102109
...
#       You are successfully logged in to: gl-plane2-09 - site: largescale / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU router bgp autonomous-system 4200102109
...
nv set vrf default router bgp autonomous-system 4200102109
