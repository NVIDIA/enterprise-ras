...
# NVUE CLI Configuration for cl-04
...
nv set interface swp22s0,swp22s1,swp22s2,swp22s3,swp23s0,swp23s1,swp60s0,swp60s1,swp61s0,swp61s1,swp61s2,swp61s3,swp62s0,swp62s1,swp62s2,swp62s3,swp58s0,swp58s1,swp58s2,swp58s3,swp59s0,swp59s1,swp59s2,swp59s3 link speed 200G
...
nv set interface bond1s1 evpn multihoming segment local-id 1006
nv set interface bond1s1 description su-01-node-06
...
nv set interface bond2s1 evpn multihoming segment local-id 1013
nv set interface bond2s1 description su-01-node-13
...
nv set interface bond3s1 evpn multihoming segment local-id 2002
...
nv set interface bond4s1 evpn multihoming segment local-id 2009
nv set interface bond4s1 description su-02-node-09
...
nv set interface bond5s1 evpn multihoming segment local-id 2016
nv set interface bond5s1 description su-02-node-16
...
nv set interface bond6s1 evpn multihoming segment local-id 3005
nv set interface bond6s1 description su-03-node-05
...
nv set interface bond7s1 evpn multihoming segment local-id 3012
nv set interface bond7s1 description su-03-node-12
...
nv set interface bond8s1 evpn multihoming segment local-id 4001
nv set interface bond8s1 description su-04-node-01
...
nv set interface bond9s1 evpn multihoming segment local-id 4008
nv set interface bond9s1 description su-04-node-08
...
nv set interface bond10s1 evpn multihoming segment local-id 4015
nv set interface bond10s1 description su-04-node-15
...
nv set interface bond11s1 evpn multihoming segment local-id 5004
nv set interface bond11s1 description su-05-node-04
...
nv set interface bond12s1 evpn multihoming segment local-id 5011
nv set interface bond12s1 description su-05-node-11
...
nv set interface bond13s1 evpn multihoming segment local-id 5018
nv set interface bond13s1 description su-05-node-18
...
nv set interface bond14s1 evpn multihoming segment local-id 6007
nv set interface bond14s1 description su-06-node-07
...
nv set interface bond15s1 evpn multihoming segment local-id 6014
nv set interface bond15s1 description su-06-node-14
...
nv set interface bond16s1 evpn multihoming segment local-id 7003
nv set interface bond16s1 description su-07-node-03
...
nv set interface bond17s1 evpn multihoming segment local-id 7010
nv set interface bond17s1 description su-07-node-10
...
nv set interface bond18s1 evpn multihoming segment local-id 7017
nv set interface bond18s1 description su-07-node-17
...
nv set interface bond19s1 evpn multihoming segment local-id 8006
nv set interface bond19s1 description su-08-node-06
...
nv set interface bond20s1 evpn multihoming segment local-id 8013
nv set interface bond20s1 description su-08-node-13
...
nv set interface bond22s2 evpn multihoming segment local-id 800006
nv set interface bond22s2 description support-06
nv set interface bond22s3 bond member swp22s3
nv set interface bond22s3 evpn multihoming segment local-id 1800006
nv set interface bond22s3 description support-06
...
# SUPPORT role - 2 ports, 6 bonds
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 evpn multihoming segment state enabled
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 type bond
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 bridge domain br_default vlan 200,300,400
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 bridge domain br_default untagged 300
nv set interface bond22s0,bond22s1,bond22s2,bond22s3,bond23s0,bond23s1 bond lacp-bypass enabled
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.14/32
...
#============================================================================
nv set interface vlan300 ipv4 address 172.16.178.5/24
...
nv set interface vlan400 ipv4 address 172.16.179.5/24
...
nv set nve vxlan source address 172.16.1.14

#============================================================================
# BGP - Underlay and EVPN
#============================================================================
nv set router bgp state enabled
nv set router bgp autonomous-system 4200100405
nv set router bgp router-id 172.16.1.14
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.186/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.170/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 20 match 172.16.178.5/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 30 match 172.16.179.5/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.170/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.154/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.154/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.154/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.170/32
...
nv set vrf EXIT router bgp autonomous-system 4200100405
...
nv set vrf EXIT router bgp router-id 172.16.1.186

nv set vrf STORAGE evpn state enabled
nv set vrf STORAGE evpn vlan 3005
nv set vrf STORAGE evpn vni 5005

nv set vrf STORAGE loopback ip address 172.16.1.202/32
...
nv set vrf STORAGE router bgp autonomous-system 4200100405
...
nv set vrf STORAGE router bgp router-id 172.16.1.202
...
#       You are successfully logged in to: cl-04 - site: largescale / arch: 2-4-5-800
####################################################################'
