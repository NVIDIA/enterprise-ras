...
# NVUE CLI Configuration for gl-plane2-01
...
nv set interface lo ipv4 address 10.1.2.1/32
...
nv set nve vxlan source address 10.1.2.1
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102101
nv set router bgp state enabled
nv set router bgp router-id 10.1.2.1
...
nv set system hostname gl-plane2-01
...
#       You are successfully logged in to: gl-plane2-01 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.2.11/32
...
nv set vrf GPU router bgp autonomous-system 4200102101
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.2.1
...
nv set vrf default router bgp autonomous-system 4200102101
...
nv set vrf default router bgp router-id 10.1.2.1
