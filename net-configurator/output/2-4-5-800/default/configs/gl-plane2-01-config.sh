...
nv set interface lo ipv4 address 10.2.1.1/32
...
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1 bridge domain br_default access 921
...
nv set nve vxlan source address 10.2.1.1
...
nv set vrf GPU router bgp router-id 10.2.1.1
...
nv set vrf default router bgp router-id 10.2.1.1
