...
# NVUE CLI Configuration for rack-oob-su-01-02
...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.104/32
...
# VLAN SVI
#============================================================================
nv set interface vlan200 ipv4 address 192.168.200.5/24
...
nv set nve vxlan source address 172.16.1.104
...
nv set router bgp autonomous-system 4200100005
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.104
...
nv set system hostname rack-oob-su-01-02
...
#       You are successfully logged in to: rack-oob-su-01-02 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.1.124/32
...
nv set vrf OOB router bgp autonomous-system 4200100005
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.1.124
