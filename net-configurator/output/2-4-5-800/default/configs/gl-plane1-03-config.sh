...
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1 bridge domain br_default access 903
# vlan903 SVI (rail rail3_plane1)
nv set interface vlan903 ipv4 address 192.168.3.4/24
