...
# NVUE CLI Configuration for gl-plane1-03
...
nv set interface lo ipv4 address 10.1.1.3/32
...
nv set interface vlan900 ipv4 address 192.168.0.4/20
...
nv set nve vxlan source address 10.1.1.3
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200101103
nv set router bgp state enabled
nv set router bgp router-id 10.1.1.3
...
nv set system hostname gl-plane1-03
...
#       You are successfully logged in to: gl-plane1-03 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.1.13/32
...
nv set vrf GPU router bgp autonomous-system 4200101103
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.1.1.3
...
nv set vrf default router bgp autonomous-system 4200101103
...
nv set vrf default router bgp router-id 10.1.1.3
