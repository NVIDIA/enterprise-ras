...
# Generated: 2026-07-02T12:36:47Z
...
nv set interface swp9,swp10,swp11,swp12,swp13,swp7 link breakout 2x lanes-per-port 4
nv set interface swp8 link breakout 8x lanes-per-port 1
...
nv set interface bond1s1 evpn multihoming segment local-id 1002
nv set interface bond1s1 description su-01-node-02
nv set interface bond1s2 bond member swp1s2
nv set interface bond1s2 evpn multihoming segment local-id 1003
nv set interface bond1s2 description su-01-node-03
nv set interface bond1s3 bond member swp1s3
nv set interface bond1s3 evpn multihoming segment local-id 1004
nv set interface bond1s3 description su-01-node-04

nv set interface bond2s0 bond member swp2s0
nv set interface bond2s0 evpn multihoming segment local-id 1005
nv set interface bond2s0 description su-01-node-05
nv set interface bond2s1 bond member swp2s1
nv set interface bond2s1 evpn multihoming segment local-id 1006
nv set interface bond2s1 description su-01-node-06
nv set interface bond2s2 bond member swp2s2
nv set interface bond2s2 evpn multihoming segment local-id 1007
nv set interface bond2s2 description su-01-node-07
nv set interface bond2s3 bond member swp2s3
nv set interface bond2s3 evpn multihoming segment local-id 1008
nv set interface bond2s3 description su-01-node-08

nv set interface bond3s0 bond member swp3s0
nv set interface bond3s0 evpn multihoming segment local-id 1009
nv set interface bond3s0 description su-01-node-09
nv set interface bond3s1 bond member swp3s1
nv set interface bond3s1 evpn multihoming segment local-id 1010
nv set interface bond3s1 description su-01-node-10
nv set interface bond3s2 bond member swp3s2
nv set interface bond3s2 evpn multihoming segment local-id 1011
nv set interface bond3s2 description su-01-node-11
nv set interface bond3s3 bond member swp3s3
nv set interface bond3s3 evpn multihoming segment local-id 1012
nv set interface bond3s3 description su-01-node-12

nv set interface bond4s0 bond member swp4s0
nv set interface bond4s0 evpn multihoming segment local-id 1013
nv set interface bond4s0 description su-01-node-13
nv set interface bond4s1 bond member swp4s1
nv set interface bond4s1 evpn multihoming segment local-id 1014
nv set interface bond4s1 description su-01-node-14
nv set interface bond4s2 bond member swp4s2
nv set interface bond4s2 evpn multihoming segment local-id 1015
nv set interface bond4s2 description su-01-node-15
nv set interface bond4s3 bond member swp4s3
nv set interface bond4s3 evpn multihoming segment local-id 1016
nv set interface bond4s3 description su-01-node-16

nv set interface bond5s0 bond member swp5s0
nv set interface bond5s0 evpn multihoming segment local-id 1017
nv set interface bond5s0 description su-01-node-17
nv set interface bond5s1 bond member swp5s1
nv set interface bond5s1 evpn multihoming segment local-id 1018
nv set interface bond5s1 description su-01-node-18

nv set interface bond6s0 bond member swp6s0
nv set interface bond6s0 evpn multihoming segment local-id 800001
nv set interface bond6s0 description support-01
nv set interface bond6s1 bond member swp6s1
nv set interface bond6s1 evpn multihoming segment local-id 800002
nv set interface bond6s1 description support-02
nv set interface bond6s2 bond member swp6s2
nv set interface bond6s2 evpn multihoming segment local-id 800003
nv set interface bond6s2 description support-03
nv set interface bond6s3 bond member swp6s3
nv set interface bond6s3 evpn multihoming segment local-id 800004
nv set interface bond6s3 description support-04

nv set interface bond7s0 bond member swp7s0
nv set interface bond7s0 evpn multihoming segment local-id 800005
nv set interface bond7s0 description support-05
nv set interface bond7s1 bond member swp7s1
nv set interface bond7s1 evpn multihoming segment local-id 800006
nv set interface bond7s1 description support-06

# CPU role - 7 ports, 24 bonds
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 evpn multihoming segment state enabled
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 type bond
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 bridge domain br_default vlan 300,400
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 bridge domain br_default untagged 300
nv set interface bond1s0,bond1s1,bond1s2,bond1s3,bond2s0,bond2s1,bond2s2,bond2s3,bond3s0,bond3s1,bond3s2,bond3s3,bond4s0,bond4s1,bond4s2,bond4s3,bond5s0,bond5s1,bond6s0,bond6s1,bond6s2,bond6s3,bond7s0,bond7s1 bond lacp-bypass enabled

nv set interface bond5s2 bond member swp5s2
nv set interface bond5s2 evpn multihoming segment local-id 900001
nv set interface bond5s2 description storage-01
nv set interface bond5s3 bond member swp5s3
nv set interface bond5s3 evpn multihoming segment local-id 1900001
nv set interface bond5s3 description storage-01

# STORAGE role - 1 ports, 2 bonds
nv set interface bond5s2,bond5s3 evpn multihoming segment state enabled
nv set interface bond5s2,bond5s3 evpn multihoming segment mac-address 44:38:39:FF:00:AC
nv set interface bond5s2,bond5s3 type bond
nv set interface bond5s2,bond5s3 bridge domain br_default vlan 400,500
nv set interface bond5s2,bond5s3 bridge domain br_default untagged 300
nv set interface bond5s2,bond5s3 bond lacp-bypass enabled
...
nv set interface swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3 description 'ISL to other core switch'
nv set interface swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3 evpn multihoming uplink enabled

# EDGE role - direct interfaces
nv set interface swp7s2,swp7s3,swp8s0,swp8s1 description 'Edge uplinks'
nv set interface swp7s2,swp7s3,swp8s0,swp8s1 vrf EXIT

# OOB role - direct L3 uplinks
nv set interface swp8s2,swp8s3 description 'OOB uplinks'
...
nv set interface swp14,swp15,swp16,swp17,swp18,swp19,swp20,swp21,swp22,swp23,swp24,swp25,swp26,swp27,swp28,swp29,swp30,swp31,swp32,swp33,swp34,swp35,swp36,swp37,swp38,swp39,swp40,swp41,swp42,swp43,swp44,swp45,swp46,swp47,swp48,swp49,swp50,swp51,swp52,swp53,swp54,swp55,swp56,swp57,swp58,swp59,swp60,swp61,swp62,swp63,swp64,swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 type swp

nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 telemetry histogram counter counter-type rx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 telemetry histogram counter counter-type tx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 telemetry histogram egress-buffer traffic-class 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 telemetry histogram ingress-buffer priority-group 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp5s2,swp5s3,swp9s0,swp9s1,swp9s2,swp9s3,swp10s0,swp10s1,swp10s2,swp10s3,swp11s0,swp11s1,swp11s2,swp11s3,swp12s0,swp12s1,swp12s2,swp12s3,swp13s0,swp13s1,swp13s2,swp13s3,swp8s2,swp8s3,swp7s2,swp7s3,swp8s0,swp8s1 telemetry histogram ingress-buffer priority-group 1
...
nv set router policy prefix-list EXIT_LOCAL_IF rule 10 match 172.16.1.6/32 max-prefix-len 32
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 action permit
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.1.42/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 30 match 172.16.1.42/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.1.32/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.1.32/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.1.32/32 max-prefix-len 32
...
nv set vrf INBAND loopback ip address 172.16.1.42/32
...
nv set vrf INBAND router bgp router-id 172.16.1.42

nv set vrf OOB evpn state enabled
nv set vrf OOB evpn vlan 3001
nv set vrf OOB evpn vni 5001

nv set vrf OOB loopback ip address 172.16.1.32/32
...
nv set vrf OOB router bgp router-id 172.16.1.32

nv set vrf EXIT evpn state enabled
nv set vrf EXIT evpn vlan 3004
nv set vrf EXIT evpn vni 5004

nv set vrf EXIT loopback ip address 172.16.1.6/32
...
nv set vrf EXIT router bgp neighbor swp7s2 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp7s2 type unnumbered
nv set vrf EXIT router bgp neighbor swp7s3 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp7s3 type unnumbered
nv set vrf EXIT router bgp neighbor swp8s0 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp8s0 type unnumbered
nv set vrf EXIT router bgp neighbor swp8s1 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp8s1 type unnumbered
...
nv set vrf STORAGE router bgp router-id 172.16.1.52
...
nv set vrf default router bgp neighbor swp9s0 peer-group internal-isl
nv set vrf default router bgp neighbor swp9s0 type unnumbered
nv set vrf default router bgp neighbor swp9s1 peer-group internal-isl
nv set vrf default router bgp neighbor swp9s1 type unnumbered
nv set vrf default router bgp neighbor swp9s2 peer-group internal-isl
nv set vrf default router bgp neighbor swp9s2 type unnumbered
nv set vrf default router bgp neighbor swp9s3 peer-group internal-isl
nv set vrf default router bgp neighbor swp9s3 type unnumbered
nv set vrf default router bgp neighbor swp10s0 peer-group internal-isl
nv set vrf default router bgp neighbor swp10s0 type unnumbered
nv set vrf default router bgp neighbor swp10s1 peer-group internal-isl
nv set vrf default router bgp neighbor swp10s1 type unnumbered
nv set vrf default router bgp neighbor swp10s2 peer-group internal-isl
nv set vrf default router bgp neighbor swp10s2 type unnumbered
nv set vrf default router bgp neighbor swp10s3 peer-group internal-isl
nv set vrf default router bgp neighbor swp10s3 type unnumbered
nv set vrf default router bgp neighbor swp11s0 peer-group internal-isl
nv set vrf default router bgp neighbor swp11s0 type unnumbered
nv set vrf default router bgp neighbor swp11s1 peer-group internal-isl
nv set vrf default router bgp neighbor swp11s1 type unnumbered
nv set vrf default router bgp neighbor swp11s2 peer-group internal-isl
nv set vrf default router bgp neighbor swp11s2 type unnumbered
nv set vrf default router bgp neighbor swp11s3 peer-group internal-isl
nv set vrf default router bgp neighbor swp11s3 type unnumbered
nv set vrf default router bgp neighbor swp12s0 peer-group internal-isl
nv set vrf default router bgp neighbor swp12s0 type unnumbered
nv set vrf default router bgp neighbor swp12s1 peer-group internal-isl
nv set vrf default router bgp neighbor swp12s1 type unnumbered
nv set vrf default router bgp neighbor swp12s2 peer-group internal-isl
nv set vrf default router bgp neighbor swp12s2 type unnumbered
nv set vrf default router bgp neighbor swp12s3 peer-group internal-isl
nv set vrf default router bgp neighbor swp12s3 type unnumbered
nv set vrf default router bgp neighbor swp13s0 peer-group internal-isl
nv set vrf default router bgp neighbor swp13s0 type unnumbered
nv set vrf default router bgp neighbor swp13s1 peer-group internal-isl
nv set vrf default router bgp neighbor swp13s1 type unnumbered
nv set vrf default router bgp neighbor swp13s2 peer-group internal-isl
nv set vrf default router bgp neighbor swp13s2 type unnumbered
nv set vrf default router bgp neighbor swp13s3 peer-group internal-isl
nv set vrf default router bgp neighbor swp13s3 type unnumbered
nv set vrf default router bgp neighbor swp8s2 peer-group underlay
nv set vrf default router bgp neighbor swp8s2 type unnumbered
nv set vrf default router bgp neighbor swp8s3 peer-group underlay
nv set vrf default router bgp neighbor swp8s3 type unnumbered
...
#       You are successfully logged in to: cl-02 - site: default / arch: 2-4-5-800
####################################################################'
