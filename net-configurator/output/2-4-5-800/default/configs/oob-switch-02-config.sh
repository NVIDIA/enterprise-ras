...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.102/32
...
nv set nve vxlan source address 172.16.1.102
...
nv set router bgp autonomous-system 4200100003
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.102
...
#       You are successfully logged in to: oob-switch-02 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.1.122/32
...
nv set vrf OOB router bgp autonomous-system 4200100003
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.1.122
