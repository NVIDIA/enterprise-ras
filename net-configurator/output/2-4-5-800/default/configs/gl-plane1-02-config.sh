...
# NVUE CLI Configuration for gl-plane1-02
...
nv set interface vlan900 ipv4 address 192.168.0.3/20
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200101102
...
nv set system hostname gl-plane1-02
...
#       You are successfully logged in to: gl-plane1-02 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.1.12/32
...
nv set vrf GPU router bgp autonomous-system 4200101102
...
nv set vrf default router bgp autonomous-system 4200101102
