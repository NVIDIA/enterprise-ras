...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.1.101/32
...
nv set interface swp1-48,swp49,swp50 type swp

#============================================================================
# VLAN SVI
#============================================================================
nv set interface vlan200 ipv4 address 192.168.200.2/24
...
nv set nve vxlan source address 172.16.1.101
...
nv set router bgp autonomous-system 4200100002
nv set router bgp state enabled
nv set router bgp router-id 172.16.1.101
...
nv set system hostname oob-switch-01
...
#       You are successfully logged in to: oob-switch-01 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf OOB loopback ip address 172.16.1.121/32
...
nv set vrf OOB router bgp autonomous-system 4200100002
nv set vrf OOB router bgp state enabled
nv set vrf OOB router bgp router-id 172.16.1.121
...
nv set vrf default router bgp neighbor swp50 peer-group underlay
