...
nv set interface lo ipv4 address 10.1.2.4/32
...
nv set interface vlan900 ipv4 address 192.168.16.5/20
...
nv set nve vxlan source address 10.1.2.4
...
nv set router bgp router-id 10.1.2.4
...
nv set vrf GPU loopback ip address 10.1.2.14/32
...
nv set vrf GPU router bgp router-id 10.1.2.4
...
nv set vrf default router bgp router-id 10.1.2.4
