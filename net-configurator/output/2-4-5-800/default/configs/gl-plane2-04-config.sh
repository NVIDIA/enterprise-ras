...
# NVUE CLI Configuration for gl-plane2-04
...
nv set interface lo ipv4 address 10.2.1.4/32
...
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1 bridge domain br_default access 924
# vlan924 SVI (rail rail4_plane2)
nv set interface vlan924 ipv4 address 192.168.24.5/24
...
nv set nve vxlan source address 10.2.1.4
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102104
nv set router bgp state enabled
nv set router bgp router-id 10.2.1.4
...
nv set system hostname gl-plane2-04
...
#       You are successfully logged in to: gl-plane2-04 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.2.1.24/32
...
nv set vrf GPU router bgp autonomous-system 4200102104
nv set vrf GPU router bgp state enabled
nv set vrf GPU router bgp router-id 10.2.1.4
...
nv set vrf default router bgp autonomous-system 4200102104
...
nv set vrf default router bgp router-id 10.2.1.4
