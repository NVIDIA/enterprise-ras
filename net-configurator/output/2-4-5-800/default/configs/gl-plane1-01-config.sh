...
# NVUE CLI Configuration for gl-plane1-01
...
nv set interface vlan900 ipv4 address 192.168.0.2/20
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200101101
...
nv set system hostname gl-plane1-01
...
#       You are successfully logged in to: gl-plane1-01 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU loopback ip address 10.1.1.11/32
...
nv set vrf GPU router bgp autonomous-system 4200101101
...
nv set vrf default router bgp autonomous-system 4200101101
