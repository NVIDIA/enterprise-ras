...
nv set interface lo ipv4 address 10.1.2.2/32
...
nv set interface vlan900 ipv4 address 192.168.16.3/20
...
nv set nve vxlan source address 10.1.2.2
...
nv set router bgp router-id 10.1.2.2
...
nv set vrf GPU loopback ip address 10.1.2.12/32
...
nv set vrf GPU router bgp router-id 10.1.2.2
...
nv set vrf default router bgp router-id 10.1.2.2
