...
# NVUE CLI Configuration for gl-plane2-02
...
nv set interface swp1s0,swp1s1,swp2s0,swp2s1,swp3s0,swp3s1,swp4s0,swp4s1,swp5s0,swp5s1,swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1 bridge domain br_default access 922
...
# Router policy
#============================================================================
nv set router bgp autonomous-system 4200102102
...
nv set system hostname gl-plane2-02
...
#       You are successfully logged in to: gl-plane2-02 - site: default / arch: 2-4-5-800
####################################################################'
...
nv set vrf GPU router bgp autonomous-system 4200102102
...
nv set vrf default router bgp autonomous-system 4200102102
