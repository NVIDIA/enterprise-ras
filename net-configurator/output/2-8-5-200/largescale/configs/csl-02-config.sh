...
# Generated: 2026-07-03T00:13:03Z
...
#============================================================================
nv set interface swp1,swp2,swp3,swp4,swp5,swp6,swp7,swp8,swp25,swp51 link breakout 4x lanes-per-port 2
nv set interface swp27,swp28,swp29,swp30,swp31,swp32,swp33,swp34,swp35 link breakout 2x lanes-per-port 4
nv set interface swp49,swp59 link breakout 8x lanes-per-port 1

nv set interface swp50,swp52,swp60,swp62,swp64 link breakout disabled
...
# STORAGE role - 2 ports, 4 bonds
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 evpn multihoming segment state enabled
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 evpn multihoming segment mac-address 44:38:39:FF:00:AA
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 type bond
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 bridge domain br_default vlan 400,500
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 bridge domain br_default untagged 300
nv set interface bond49s6,bond49s7,bond51s0,bond51s1 bond lacp-bypass enabled
...
nv set interface swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1 description 'ISL to other core switch'
nv set interface swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1 evpn multihoming uplink enabled

# EDGE role - direct interfaces
nv set interface swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 description 'Edge uplinks'
nv set interface swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 vrf EXIT

# OOB role - direct L3 uplinks
nv set interface swp49s0,swp49s1 description 'OOB uplinks'
...
nv set interface swp9,swp10,swp11,swp12,swp13,swp14,swp15,swp16,swp17,swp18,swp19,swp20,swp21,swp22,swp23,swp24,swp26,swp36,swp37,swp38,swp39,swp40,swp41,swp42,swp43,swp44,swp45,swp46,swp47,swp48,swp53,swp54,swp55,swp56,swp57,swp58,swp61,swp63,swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 type swp

nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 telemetry histogram counter counter-type rx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 telemetry histogram counter counter-type tx-packet
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 telemetry histogram egress-buffer traffic-class 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 telemetry histogram ingress-buffer priority-group 0
nv set interface swp1s0,swp1s1,swp1s2,swp1s3,swp2s0,swp2s1,swp2s2,swp2s3,swp3s0,swp3s1,swp3s2,swp3s3,swp4s0,swp4s1,swp4s2,swp4s3,swp5s0,swp5s1,swp5s2,swp5s3,swp6s0,swp6s1,swp6s2,swp6s3,swp7s0,swp7s1,swp7s2,swp7s3,swp8s0,swp8s1,swp8s2,swp8s3,swp25s0,swp25s1,swp49s6,swp49s7,swp51s0,swp51s1,swp27s0,swp27s1,swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp49s0,swp49s1,swp59s0,swp59s1,swp59s2,swp59s3,swp59s4,swp59s5,swp59s6,swp59s7 telemetry histogram ingress-buffer priority-group 1
...
nv set router policy prefix-list INBAND_LOCAL_IF rule 10 match 172.16.176.42/32 max-prefix-len 32
...
nv set router policy prefix-list INBAND_PREFIXES rule 40 match 172.16.176.42/32 max-prefix-len 32
...
nv set router policy prefix-list LOCAL_OOB_LOOPBACK rule 10 match 172.16.176.32/32 max-prefix-len 32
nv set router policy prefix-list OOB_LOCAL_IF rule 10 action permit
nv set router policy prefix-list OOB_LOCAL_IF rule 10 match 172.16.176.32/32 max-prefix-len 32
...
nv set router policy prefix-list OOB_PREFIXES rule 20 match 172.16.176.32/32 max-prefix-len 32
...
nv set vrf EXIT router bgp neighbor swp59s6 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp59s6 type unnumbered
nv set vrf EXIT router bgp neighbor swp59s7 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp59s7 type unnumbered
...
nv set vrf INBAND loopback ip address 172.16.176.42/32
...
nv set vrf INBAND router bgp router-id 172.16.176.42
