...
#============================================================================
nv set interface swp1,swp2,swp3,swp4,swp5,swp26,swp27 link breakout 4x lanes-per-port 2
...
nv set interface swp49,swp51,swp59,swp61,swp63 link breakout 8x lanes-per-port 1
...
nv set interface bond49s6,bond49s7,bond51s0,bond51s1,bond51s2,bond51s3,bond51s4,bond51s5,bond51s6,bond51s7 evpn multihoming segment mac-address 44:38:39:FF:00:AA
nv set interface bond49s6,bond49s7,bond51s0,bond51s1,bond51s2,bond51s3,bond51s4,bond51s5,bond51s6,bond51s7 type bond
nv set interface bond49s6,bond49s7,bond51s0,bond51s1,bond51s2,bond51s3,bond51s4,bond51s5,bond51s6,bond51s7 bridge domain br_default access 500
nv set interface bond49s6,bond49s7,bond51s0,bond51s1,bond51s2,bond51s3,bond51s4,bond51s5,bond51s6,bond51s7 bond lacp-bypass enabled
...
nv set interface swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp21s1,swp22s0,swp22s1,swp23s0,swp23s1,swp24s0,swp24s1,swp25s0,swp25s1 bridge domain br_default access 900

# GPU role - QoS PFC watchdog
nv set interface swp6s0,swp6s1,swp7s0,swp7s1,swp8s0,swp8s1,swp9s0,swp9s1,swp10s0,swp10s1,swp11s0,swp11s1,swp12s0,swp12s1,swp13s0,swp13s1,swp14s0,swp14s1,swp15s0,swp15s1,swp16s0,swp16s1,swp17s0,swp17s1,swp18s0,swp18s1,swp19s0,swp19s1,swp20s0,swp20s1,swp21s0,swp21s1,swp22s0,swp22s1,swp23s0,swp23s1,swp24s0,swp24s1,swp25s0,swp25s1 qos pfc-watchdog state enable

# ISL role - direct interfaces
nv set interface swp28s0,swp28s1,swp29s0,swp29s1,swp30s0,swp30s1,swp31s0,swp31s1,swp32s0,swp32s1,swp33s0,swp33s1,swp34s0,swp34s1,swp35s0,swp35s1,swp36s0,swp36s1,swp37s0,swp37s1,swp38s0,swp38s1,swp39s0,swp39s1,swp40s0,swp40s1,swp41s0,swp41s1,swp42s0,swp42s1,swp43s0,swp43s1,swp44s0,swp44s1,swp45s0,swp45s1,swp46s0,swp46s1,swp47s0,swp47s1 description 'ISL to other core switch'
