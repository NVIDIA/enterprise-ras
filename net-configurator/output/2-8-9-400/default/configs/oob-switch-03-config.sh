...
# Loopback
#============================================================================
nv set interface lo ipv4 address 172.16.176.23/32
...
nv set nve vxlan source address 172.16.176.23
...
nv set router bgp router-id 172.16.176.23
...
nv set vrf OOB loopback ip address 172.16.176.33/32
...
nv set vrf OOB router bgp router-id 172.16.176.33
