...
nv set interface spine_bond,swp1-5,10-15,27-40,49-57,60-61 link state up
nv set interface spine_bond,swp1-5,10-15,27-40,53-57,60-61 bridge domain br_default access 200
nv set interface swp1-5,10-15,27-40,49-57,60-61 type swp
