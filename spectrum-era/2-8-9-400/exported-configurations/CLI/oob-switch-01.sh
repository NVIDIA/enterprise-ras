...
nv set interface spine_bond,swp1-6,25-42,45-47,49-57,60-61 link state up
nv set interface spine_bond,swp1-6,25-42,45-47,53-57,60-61 bridge domain br_default access 200
nv set interface swp1-6,25-42,45-47,49-57,60-61 type swp
nv set interface vlan200 ip address 192.168.200.2/24
...
#                     You are successfully logged in to: oob-switch-01              #
#####################################################################################
'
