...
nv set interface spine_bond,swp1-5,25-34,36-41,45,47,53-57,60-61 bridge domain br_default access 200
nv set interface swp1-5,25-34,36-41,45,47,49-57,60-61 link state up
nv set interface swp1-5,25-34,36-41,45,47,49-57,60-61 type swp
nv set interface vlan200 ip address 192.168.220.2/24
...
nv set vrf default router static 0.0.0.0/0 via 192.168.220.1 type ipv4-address
