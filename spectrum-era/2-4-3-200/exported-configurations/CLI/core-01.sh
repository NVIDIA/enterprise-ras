...
nv set vrf EXIT router bgp neighbor swp61s0-1,swp63s0-1 update-source 172.16.176.11
...
nv set vrf default router bgp neighbor swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 update-source 172.16.176.11
