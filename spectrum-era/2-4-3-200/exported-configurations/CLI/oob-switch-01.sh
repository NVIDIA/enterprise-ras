...
nv set interface spine_bond bond member swp49,51
nv set interface spine_bond type bond
nv set interface spine_bond,swp1-48 bridge domain br_default access 200
nv set interface spine_bond,swp1-49,51 link state up
nv set interface swp1-49,51 type swp
