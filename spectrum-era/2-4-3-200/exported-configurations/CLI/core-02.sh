...
nv set interface bond1s0-3,bond2s0-3,bond3s0-3,bond4s0-3,bond5s0-3,bond6s0-3,bond7s0-3,bond8s0-3 bridge domain br_default access 300
nv set interface bond1s0-3,bond2s0-3,bond3s0-3,bond4s0-3,bond5s0-3,bond6s0-3,bond7s0-3,bond8s0-3,bond25s0-3,bond26s0-2 bond lacp-bypass on
nv set interface bond1s0-3,bond2s0-3,bond3s0-3,bond4s0-3,bond5s0-3,bond6s0-3,bond7s0-3,bond8s0-3,bond25s0-3,bond26s0-2,bond59s0-4 evpn multihoming segment enable on
nv set interface bond1s0-3,bond2s0-3,bond3s0-3,bond4s0-3,bond5s0-3,bond6s0-3,bond7s0-3,bond8s0-3,bond25s0-3,bond26s0-2,bond59s0-4 evpn multihoming segment mac-address 44:38:39:FF:00:AA
nv set interface bond1s0-3,bond2s0-3,bond3s0-3,bond4s0-3,bond5s0-3,bond6s0-3,bond7s0-3,bond8s0-3,bond25s0-3,bond26s0-2,bond59s0-4 type bond
...
nv set interface bond25s0-3,bond26s0 bridge domain br_default vlan 400
nv set interface bond25s0-3,bond26s0-2 bridge domain br_default untagged 300
...
nv set interface bond26s1-2 bridge domain br_default vlan 500
nv set interface bond26s2 bond member swp26s2
nv set interface bond26s2 evpn multihoming segment local-id 262
nv set interface bond59s0 bond member swp59s0
nv set interface bond59s0 evpn multihoming segment local-id 590
nv set interface bond59s0-4 bridge domain br_default access 200
nv set interface bond59s1 bond member swp59s1
nv set interface bond59s1 evpn multihoming segment local-id 591
nv set interface bond59s2 bond member swp59s2
nv set interface bond59s2 evpn multihoming segment local-id 592
nv set interface bond59s3 bond member swp59s3
nv set interface bond59s3 evpn multihoming segment local-id 593
nv set interface bond59s4 bond member swp59s4
nv set interface bond59s4 evpn multihoming segment local-id 594
nv set interface eth0 ip address dhcp
nv set interface eth0 ip vrf mgmt
nv set interface eth0 type eth
nv set interface lo ip address 172.16.176.12/32
nv set interface lo type loopback
nv set interface swp1,9-10,25-59,61,63 link state up
nv set interface swp1-8,25-26 link breakout 4x lanes-per-port 2
nv set interface swp1-64,swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 type swp
nv set interface swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 telemetry histogram counter counter-type rx-packet
nv set interface swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 telemetry histogram counter counter-type tx-packet
nv set interface swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 telemetry histogram egress-buffer traffic-class 0
nv set interface swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 telemetry histogram ingress-buffer priority-group 0
nv set interface swp1s0-3,swp2s0-3,swp3s0-3,swp4s0-3,swp5s0-3,swp6s0-3,swp7s0-3,swp8s0-3,swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1,swp25s0-3,swp26s0-2,swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1,swp59s0-4,swp61s0-1,swp63s0-1 telemetry histogram ingress-buffer priority-group 1
nv set interface swp2-8 link state down
nv set interface swp9-24,27-58 link breakout 2x lanes-per-port 4
nv set interface swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1 bridge domain br_default access 900
nv set interface swp9s0-1,swp10s0-1,swp11s0-1,swp12s0-1,swp13s0-1,swp14s0-1,swp15s0-1,swp16s0-1,swp17s0-1,swp18s0-1,swp19s0-1,swp20s0-1,swp21s0-1,swp22s0-1,swp23s0-1,swp24s0-1 qos pfc-watchdog state enable
nv set interface swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 description 'ISL to other core switch'
nv set interface swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 evpn multihoming uplink on
nv set interface swp59,61,63 link breakout 8x lanes-per-port 1
nv set interface swp60,62,64 link breakout disabled
nv set interface swp61s0-1,swp63s0-1 description 'Edge uplinks'
nv set interface swp61s0-1,swp63s0-1 ip vrf EXIT
nv set interface vlan200 ip address 172.16.177.3/24
...
nv set interface vlan300 ip address 172.16.178.3/24
...
nv set service dhcp-relay EXIT server 192.168.200.2
nv set service dhcp-relay EXIT server 192.168.210.2
...
nv set vrf EXIT router bgp neighbor swp61s0-1,swp63s0-1 peer-group underlay-esl-external
nv set vrf EXIT router bgp neighbor swp61s0-1,swp63s0-1 type unnumbered
nv set vrf EXIT router bgp neighbor swp61s0-1,swp63s0-1 update-source 172.16.176.12
...
nv set vrf default router bgp neighbor swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 peer-group underlay
nv set vrf default router bgp neighbor swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 ttl-security hops 1
nv set vrf default router bgp neighbor swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 type unnumbered
nv set vrf default router bgp neighbor swp27s0-1,swp28s0-1,swp29s0-1,swp30s0-1,swp31s0-1,swp32s0-1,swp33s0-1,swp34s0-1,swp35s0-1,swp36s0-1,swp37s0-1,swp38s0-1,swp39s0-1,swp40s0-1,swp41s0-1,swp42s0-1 update-source 172.16.176.12
