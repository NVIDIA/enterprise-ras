...
2-4-3-200 Release v3.0.0

## Deploying the setup on Air

Once you login to Nvidia Air, click on the `Create Simulation` button. Upload the `ERA-243-topology.json` to setup this topology on Air.
...
Repeat these steps on `oob-switch-02` as well. Use the `oob-switch-02.yaml` configuration file.
...
ubuntu@ubuntu:~$ git checkout sp-2-4-3-200-v3.0.0
ubuntu@ubuntu:~$ cd spectrum-era/2-4-3-200
```
